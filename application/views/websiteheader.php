...
if (!$basic_header_footer) {
    ...
    //User Menu - moved from top menu
    $menu_type = ($user_session ? 12500 : 14372);
    echo '<div class="dropdown inline-block sidebar-user-menu">';
    echo '<button type="button" class="btn no-side-padding dropdown-toggle sidebar-user-button" data-bs-toggle="dropdown" aria-expanded="false">';
    echo '<span class="e_cover e_cover_mini menu-cover sidebar-user-avatar">' . ($user_session && isset($user_session['usercover']) && strlen($user_session['usercover']) ? view_cover($user_session['usercover'], 1) : $users___11035[$menu_type]['m__cover']) . '</span>';
    echo '</button>';
