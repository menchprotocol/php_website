                                ...
                                if ($userid == 2125205) {
                                    ...
                                    foreach ($this->config->item('users___2125205') as $userid2 => $m2) {
                                        ...
                                        if ($userid2 == 13550) {
                                            ...
                                            //Discovery Types
                                            foreach ($this->config->item('users___13550') as $userid3 => $m3) {
                                                echo '<li class="inline-block"><a class="dropdown-item inline-block" href="javascript:coid(0);" onclick="insert_text(\'.save_postmessage\', \'@'.$m3['m__user'].'\');" title="' . $m3['m__message'] . '"><span class="icon-block-sm">' . $m3['m__cover'] . '</span>' . $m3['m__title'] . '</a></li>';
                                            }
                                            echo '<li><hr class="dropdown-divider"></li>';
