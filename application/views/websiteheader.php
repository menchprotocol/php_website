            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content long_flat">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- Handle Title -->
                        <div class="dynamic_editing_input">
                            <h3 class="mini-font"><?= '<span class="icon-block">'.$handles___6206[6197]['m__cover'].'</span><textarea class="form-control unsaved_warning save_handlevalue main__title" placeholder="..." style="margin:0; width:100%; margin-top: -20px; background-color: #FFFFFF !important;"></textarea>';  ?></h3>
                        </div>
