                                    ...
                                    foreach ($this->config->item('users___2125246') as $userid2 => $m2) {
                                        ...
                                        if ($userid2 == 13550) {
                                            ...
                                            foreach ($this->config->item('users___4737') as $userid3 => $m3) {
                                                echo '<li class="inline-block"><a class="dropdown-item inline-block text_adder" href="javascript:void(0);" text_value="@'.$m3['m__handle'].'\n" title="' . $m3['m__message'] . '"><span class="icon-block-sm">' . $m3['m__cover'] . '</span>' . $m3['m__name'] . '</a></li>';
                                            }
                                            echo '<li><hr class="dropdown-divider"></li>';
