...
if (!$basic_header_footer) {
    ...
    echo '<a href="' . view_memory(42903, 6287) . '" class="sidebar-menu-item"><span class="sidebar-menu-icon"><i class="fas fa-th-large"></i></span><span class="sidebar-menu-text">Apps</span></a>';
