            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content long_flat">
                    ...
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn btn-default post_update post_button" onclick="post_update()">POST</button>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="dynamic_editing_input single_line hash_group">
                            ...
                            <input type="text" class="form-control unsaved_warning save_posthashtag no-border" placeholder="<?= $users___12273[32337]['m__title'] ?>" maxlength="<?= view_memory(6404,41985) ?>" title="<?= $users___12273[32337]['m__message'] ?>" data-toggle="tooltip" data-placement="bottom">
                        </div>
                        ...
                        <div class="inner_message left_padded">
                            ...
                            foreach($this->config->item('users___44168') as $userid => $m){
                                ...
                                if($userid==4486){ //Ideas

                                    echo '<div class="dynamic_editing_input hidden no_padded">
                                        <a class="add_post_4486 icon-block" href="javascript:void(0)" title="'.$m['m__title'].'">'.$m['m__cover'].'</a>
                                    </div>';
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content long_flat">
                    ...
                    <div class="modal-header">
                        ...
                        <button type="button" class="user_save_edit btn btn-default post_button" onclick="user_save_edit()">SAVE</button>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <!-- User Bio -->
                        <div class="dynamic_editing_input" style="margin: 0 !important;">
                            <h3 class="mini-font"><?= '<span class="icon-block">'.$users___12274[2135504]['m__cover'].'</span>' ?><textarea class="form-control note-textarea algolia_finder editing-mode unsaved_warning algolia__e algolia__i save_userbio" placeholder="<?= ( strlen($users___12274[2135504]['m__message']) ? $users___12274[2135504]['m__message'] : $users___12274[2135504]['m__title'] ) ?>" style="margin:-23px 0 0 0; width:100%; background-color: #FFFFFF !important;"></textarea></h3>
                        </div>


                        <div class="dynamic_editing_input">

                            <h3 class="mini-font" style="margin-bottom: -38px;"><?= '<span class="icon-block">'.$users___12274[6198]['m__cover'].'</span>';  ?></h3>
                            ...
                            <div>
                                ...
                                <div style="text-align: center;"><a class="uploader_42359" class="btn btn-lrg" href="javascript:void(0);"><?= '<span class="icon-block">'.$users___11035[42359]['m__cover'].'</span>'.$users___11035[42359]['m__title'] ?></a></div>
