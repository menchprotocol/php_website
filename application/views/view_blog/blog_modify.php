    ...
    foreach ($this->config->item('en_all_'.$en_id) as $en_id2 => $m2){
        ...
        if($en_id2==11019){
            ...
            $this_tab .= '<div class="list_input grey-block '.require_superpower(10939).'">
                           ...
                           <div class="algolia_search_pad in_pad_top hidden"><span class="icon-block"><i class="fas fa-search-plus yellow"></i></span><b class="montserrat">Search blogs or create a new one...</b></div>
                    </div>';
            ...
            if(in_can_train($in['in_id'])){
                $this_tab .= '<div class="list_input grey-block">
                   ...
                   <div class="algolia_search_pad in_pad_bottom hidden"><span class="icon-block"><i class="fas fa-search-plus yellow"></i></span><b class="montserrat">Search blogs or create a new one...</b></div>
            </div>';
            } else {
