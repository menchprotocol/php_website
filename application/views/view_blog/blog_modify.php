...
foreach ($this->config->item('en_all_11021') as $en_id => $m){
    ...
    if($col_num==1){
        ...
        echo '<div>';
            ...
            echo '<div class="inline-block" style="margin-left: 5px;"><a href="/'.$in['in_id'].'" title="Read this blog as a reader" data-toggle="tooltip" data-placement="bottom" class="btn btn-sm btn-read"><i class="far fa-eye"></i></a></div>';
        echo '</div>';
