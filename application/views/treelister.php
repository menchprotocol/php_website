...
foreach($this->Mench_ledger->fetch(array(
    ...
    echo '<h3 style="margin-top: 55px;"><a href="'.view__memory(42903,33286).$link_i['ideahashtag'].'">'.view__i_title($link_i).'</a> ['.count($list_settings['query_string_filtered']).' Total]</h3>';
