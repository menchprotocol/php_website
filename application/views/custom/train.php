	...
	<div class="section section-contacts" style="padding-top:80px;">
		<div class="row">
			<div class="col-md-8 col-md-offset-2" style="text-align:center;">
				<?php
	    		if(isset($udata['u_id'])){
	    			echo '<a href="/intents/'.$this->config->item('primary_c').'" class="btn btn-danger btn-raised btn-lg">Console <i class="fas fa-chevron-circle-right" style="font-size:1.2em;"></i></a>';
	    		} else {
