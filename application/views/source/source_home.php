    ...
    if($session_en){
        ...
        foreach($this->DISCOVER_model->ln_fetch(array(
            ...
            if($count==$show_max){
                ...
                echo '<div class="list-group-item see_more_sources no-side-padding montserrat source"><span class="icon-block"><i class="far fa-search-plus source"></i></span><a href="javascript:void(0);" onclick="$(\'.see_more_sources\').toggleClass(\'hidden\')"><b style="text-decoration: none !important;" class="source">SEE MORE</b></a></div>';
