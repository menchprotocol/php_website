                ...
                if(superpower_active(10986, true)){
                    ...
                    if (count($child_en_filters) > 0 && $child_en_filters[0]['totals'] < $source_count) {
                        ...
                        foreach ($child_en_filters as $c_c) {
                            ...
                            $this_tab .= '<li class="nav-item"><a href="#status-' . $c_c['en_status_source_id'] . '" onclick="en_filter_status(' . $c_c['en_status_source_id'] . ')" class="nav-link u-status-filter u-status-' . $c_c['en_status_source_id'] . '" data-toggle="tooltip" data-placement="top" title="' . $st['m_desc'] . '">' . $st['m_icon'] . '<span class="show-max '.extract_icon_color($st['m_icon']).'"> ' . $st['m_name'] . '</span> <span class="count-en-status-' . $c_c['en_status_source_id'] . '">' . $c_c['totals'] . '</span></a></li>';
                        }
