...
<div class="container">
    ...
    //Content Title
    echo '<h2 style="margin-top:34px;" class="space-left">'.$en_all_12762[12772]['m_name'].'</h2>';
    ...
    //Content Type
    echo '<h2 class="space-left">'.$en_all_12762[3000]['m_name'].'</h2>';
    echo '<div>'.echo_in_dropdown(3000, ( isset($_GET['content_type']) ? $_GET['content_type'] : 3005 /* Books */ ), 'btn-source').'</div>';


    //Content URL
    echo '<h2 style="margin-top: 21px;" class="space-left">'.$en_all_12762[12763]['m_name'].'</h2>';
    ...
    //Industry Experts
    echo '<h2 style="margin-top: 21px;" class="space-left">'.$en_all_11035[3084]['m_name'].'</h2>';
