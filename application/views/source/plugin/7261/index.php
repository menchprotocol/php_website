...
if(count($duplicates) > 0){
    ...
    foreach($duplicates as $in) {
        ...
        echo '<div><span data-toggle="tooltip" data-placement="right" title="'.$sources__4737[$in['idea__status']]['m_name'].': '.$sources__4737[$in['idea__status']]['m_desc'].'">' . $sources__4737[$in['idea__status']]['m_icon'] . '</span> <a href="/!' . $in['idea__id'] . '"><b>' . $in['idea__title'] . '</b></a> #' . $in['idea__id'] . '</div>';
    }
