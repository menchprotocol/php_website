...
if(!count($en_query)){
    echo 'IDEA: '.nl2br(print_r($this->IDEA_model->match_ln_status($session_en['en_id'], $in_query), true)).'<hr />';
}

if(!count($in_query)){
    echo 'SOURCE: '.nl2br(print_r($this->SOURCE_model->match_ln_status($session_en['en_id'], $en_query), true)).'<hr />';
}