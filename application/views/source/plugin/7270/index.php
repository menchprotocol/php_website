...
if(isset($_POST['test_message'])){
    ...
    if(intval($_POST['push_message']) && intval($_POST['recipient_en'])){
        ...
        $msg_validation = $this->COMMUNICATION_model->comm_send_message(
            $_POST['test_message'],
        ...
        $msg_validation = $this->COMMUNICATION_model->comm_validate_message($_POST['test_message'], array('en_id' => $_POST['recipient_en']), $_POST['push_message']);
