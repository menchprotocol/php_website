...
$html_message .= '<div style="padding-bottom:10px;"><b style="min-width:30px; text-align: center; display: inline-block;">🟡</b><b style="min-width:55px; display: inline-block;">'.( $idea_coins_growth_rate >= 0 ? '+' : '-' ).$idea_coins_growth_rate.'%</b><span style="min-width:55px; display: inline-block;">(<span title="'.number_format($idea_coins_last_week[0]['totals'], 0).' Coins" style="border-bottom:1px dotted #999999;">'.view_number($idea_coins_last_week[0]['totals']).'</span>)</span><a href="'.$this->config->item('base_url').'/i" target="_blank" style="color: #ffc500; font-weight:bold; text-decoration:none;">'.$sources__12467[12273]['m_name'].' &raquo;</a></div>';
...
$html_message .= '<div style="padding-bottom:10px;"><b style="min-width:30px; text-align: center; display: inline-block;">🔵</b><b style="min-width:55px; display: inline-block;">'.( $source_coins_growth_rate >= 0 ? '+' : '-' ).$source_coins_growth_rate.'%</b><span style="min-width:55px; display: inline-block;">(<span title="'.number_format($source_coins_last_week[0]['totals'], 0).' Coins" style="border-bottom:1px dotted #999999;">'.view_number($source_coins_last_week[0]['totals']).'</span>)</span><a href="'.$this->config->item('base_url').'@" target="_blank" style="color: #007AFD; font-weight:bold; text-decoration:none;">'.$sources__12467[12274]['m_name'].' &raquo;</a></div>';
...
if($is_player_request){
    ...
    $subscriber_filters['read__down'] = $session_source['source__id'];
}
