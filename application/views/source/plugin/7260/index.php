...
if(count($orphan_ins) > 0){
    ...
    if(!isset($_GET['take_action']) || $_GET['take_action']!='delete_all'){
        ...
        echo '<div class="delete-all hidden maxout"><b class="discover">WARNING</b>: All ideas and all their links will be deleted. ONLY do this after reviewing all orphans one-by-one and making sure they cannot become a child of an existing idea.<br /><br /></div>';
