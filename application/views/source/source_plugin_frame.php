...
echo '<div class="container">';
    ...
    echo '<h1 style="padding-top:5px;"><a href="/source/plugin"><span class="icon-block">'.echo_en_icon($en_all_11035[6287]['m_icon']).'</span></a><a href="/source/'.$plugin_en_id.'"><span class="icon-block">'.echo_en_icon($en_all_6287[$plugin_en_id]['m_icon']).'</span>'.$en_all_6287[$plugin_en_id]['m_name'].'</a></h1>';
