...
echo '<div class="container">';
    ...
    echo '<h1 style="padding-top:5px;"><a href="/@p"><span class="icon-block">'.view_source__icon($sources__11035[6287]['m_icon']).'</span></a><a href="/@'.$plugin_source__id.'"><span class="icon-block">'.view_source__icon($sources__6287[$plugin_source__id]['m_icon']).'</span>'.$sources__6287[$plugin_source__id]['m_name'].'</a></h1>';
