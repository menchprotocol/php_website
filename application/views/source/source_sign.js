...
function search_email(){
    ...
    $.post("/source/singin_check_email", {
        ...
        if (data.status) {
            ...
            //Show errors:
            $('#email_errors').html('<span class="icon-block"><i class="fad fa-exclamation-circle"></i></span>' + data.message + '</b>').hide().fadeIn();
            $('#input_email').focus();
        }
    });
...
function add_account(){
    ...
    $.post("/source/sign_create_account", {
        ...
        if (data.status) {
            ...
            //Show errors:
            $('#new_account_errors').html('<span class="icon-block"><i class="fad fa-exclamation-circle"></i></span>' + data.message + '</b>').hide().fadeIn();
        }
...
function singin_check_password(){
    ...
    $.post("/source/singin_check_password", {
        ...
        if (data.status) {
            ...
            //Show errors:
            $('#password_errors').html('<span class="icon-block"><i class="fad fa-exclamation-circle"></i></span>' + data.message + '</b>').hide().fadeIn();
        }
    ...
    if (r == true) {
        ...
        $.post("/source/magicemail", {
            ...
            if (data.status) {
                ...
                //Show errors:
                $('.magic_result').html('<div class="discover"><span class="icon-block"><i class="fad fa-exclamation-circle"></i></span>' + data.message + '</div>').hide().fadeIn();
            }
        });
    }
}