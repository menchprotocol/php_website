...
if(!$session_en){
    ...
    echo '<div style="margin-top: 10px;">';
        ...
        echo '<div class="alert alert-danger" role="alert"><span class="icon-block"><i class="fad fa-exclamation-triangle read"></i></span><b class="read montserrat">WARNING:</b> You are about to clear you entire reading list & delete all your<span class="icon-block"><i class="fas fa-circle read"></i></span><b class="montserrat read">READ COINS</b> (You may earn them back later by reading again)</div>';
