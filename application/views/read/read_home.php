...
if(!$session_en){
    ...
    echo '<div style="margin-top: 10px;">';
        ...
        echo '<a href="javascript:void(0)" onclick="$(\'.clear-reading-list\').toggleClass(\'hidden\')" class="pull-right grey"><span class="icon-block">'.$en_all_11035[6415]['m_icon'].'</span></a>';
