...
if($has_multiple_blogs){
    ...
    echo '<div class="pull-right clear-reading-list" style="padding:25px 0 0;"><a href="javascript:void(0)" onclick="$(\'.clear-reading-list\').toggleClass(\'hidden\')" class="montserrat doupper dolight"><span class="icon-block-sm"><i class="far fa-trash-alt"></i></span>ALL</a></div>';
