...
if(!count($player_reads)){
    ...
    echo '<div class="alert alert-danger"><span class="icon-block"><i class="fas fa-exclamation-circle read"></i></span>No books yet. Visit <a href="/" class="underline">Home</a> to get started.</div>';
