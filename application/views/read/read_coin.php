    ...
    if($read__type==4231){
        ...
        if ($counter) {
            ...
            if($idea_stats['ideas_min']!=$idea_stats['ideas_max'] || $idea_stats['duration_min']!=$idea_stats['duration_max']){
                ...
                $this_tab .= '<span class="reading-paths">Minimum:</span>'.$sources__12467[12273]['m_icon'].' <span class="reading-count">'.$idea_stats['ideas_min'].'</span> <i class="far fa-clock"></i> '.view_time_hours($idea_stats['duration_min']).'<br />';
                $this_tab .= '<span class="reading-paths">Average:</span>'.$sources__12467[12273]['m_icon'].' <span class="reading-count">'.$idea_stats['ideas_average'].'</span> <i class="far fa-clock"></i> '.view_time_hours($idea_stats['duration_average']).'<br />';
                $this_tab .= '<span class="reading-paths">Maximum:</span>'.$sources__12467[12273]['m_icon'].' <span class="reading-count">'.$idea_stats['ideas_max'].'</span> <i class="far fa-clock"></i> '.view_time_hours($idea_stats['duration_max']);
                $this_tab .= '</p>';
            }
