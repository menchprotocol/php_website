...
$in_my_reads = ( $recipient_source['source__id'] ? $this->READ_model->idea_home($idea_focus['idea__id'], $recipient_source) : false );


if($recipient_source['source__id']){
