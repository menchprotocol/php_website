    ...
    if($read__type==4231){
        ...
        if ($counter) {
            ...
            if($idea_stats['ideas_min']!=$idea_stats['ideas_max'] || $idea_stats['duration_min']!=$idea_stats['duration_max']){
                ...
                $this_tab .= '<div style="padding-bottom:21px;">The number of ideas you read (and the time it takes to read them) depends on the choices you make interactively along the way:</div>';
