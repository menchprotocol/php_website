...
echo '<div class="container">';
    ...
    echo '<h1 class="'.extract_icon_color($en_all_11035[11999]['m_icon']).'"><span class="icon-block-xlg icon_photo">'.$en_all_11035[11999]['m_icon'].'</span>'.$en_all_11035[11999]['m_name'].'</h1>';
