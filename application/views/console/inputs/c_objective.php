...
<ul>
    ...
    <li><?= $core_objects['level_'.($level-1)]['o_name'] ?> objective is also used as its title.</li>
	<?php if($level==1){ ?>
	<li>Do not include time constraints like "in 2 weeks" as total time investment is calculated using the sum of <b style="display:inline-block;"><i class="fa fa-clock-o" aria-hidden="true"></i> Estimated Time</b> values for all &nbsp;<b><i class="fa fa-check-square" aria-hidden="true"></i> Tasks</b>.</li>
	<?php } ?>
</ul>
