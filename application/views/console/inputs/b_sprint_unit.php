...
<ul>
	<li>Milestones build-up to help students accomplish the <b style="display:inline-block;"><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Bootcamp Primary Goal</b>.</li>
