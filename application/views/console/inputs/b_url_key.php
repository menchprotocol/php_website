...
<div class="form-group label-floating is-empty">
	<div class="input-group border">
      ...
      <input type="text" id="b_url_key" style="text-transform:lowercase; margin:0 0 -2px -12px !important; font-size:18px !important; " value="<?= $b_url_key ?>" maxlength="255" class="form-control" />
    </div>
    <div style="margin-bottom:20px;"><a href="/bootcamps/<?= $b_url_key ?>" target="_blank" class="btn btn-default landing_page_url">View Landing Page <i class="fa fa-external-link" style="font-size:1em;" aria-hidden="true"></i></a></div>
</div>