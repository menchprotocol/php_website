...
<ul class="maxout">
	<li>Filter students by cohort and see the leaderboard for each cohort.</li>
...
if(count($submissions)>0){
    ...
    foreach($submissions as $s){
        ...
        echo '<div class="row">';
        echo '<div class="col-sm-4"><a href="/console/'.$bootcamp['b_id'].'/milestones/'.$s['c_id'].'"><b><u>'.$s['c_objective'].'</u></b></a><br />Submitted '.( $s['us_on_time_score']==0 ? '<b style="color:#FF0000">really late</b>' : ( $s['us_on_time_score']==1 ? '<b style="color:#00CC00">on-time</b>' : '<b style="color:#FF8C00">a little late</b>' ) ).'<br />'.time_format($s['us_timestamp']).'</div>
