...
if($udata['u_status']>=3){
    ...
    echo '<iframe src="http://ec2-54-201-71-164.us-west-2.compute.amazonaws.com:3000/#/?bootcampId='.$bootcamp['b_id'].'&instructorId='.$udata['u_id'].'&token='.md5($bootcamp['b_id'].'ChatiFrameS@lt'.$udata['u_id']).'" width="100%" height="500" frameborder="0" style="overflow:hidden; border:0; padding:0; margin:0;" scrolling="no"></iframe>';
