				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
                        ...
                        <?php if(isset($uadmission) && count($uadmission)>0 && $udata['u_id']==1){ ?>
                            <li data-toggle="tooltip" data-placement="bottom" title="You are seeing this because you are a Bootcamp student. Use this to access your Action Plan on a web-based portal, which replicates the MenchBot."><a href="/my/actionplan"><i class="fa fa-graduation-cap" aria-hidden="true"></i><span> Student Hub</span></a></li>
                        <?php } ?>
