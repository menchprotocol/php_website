...
?>
<div class="title"><h4><i class="fa <?= ( $b['b_is_parent'] ? 'fa-folder-open' : 'fa-dot-circle-o' ) ?>" aria-hidden="true"></i> <?= $core_objects['level_'.($level-1)]['o_name'] ?> Primary Outcome <span id="hb_<?= $tip_index[$level] ?>" class="help_button" intent-id="<?= $tip_index[$level] ?>"></span></h4></div>
