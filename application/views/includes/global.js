        ...
        $(".this_selector").click(function (e) { //unbind().
            ...
            if($('.this_selector_'+$(this).attr('selection_i__id')+' i').hasClass('fa-square-check')){
                ...
                if(is_single_choice){
                    ...
                    //Go Next:
                    if(!$('.input_ui_'+$(this).attr('selection_i__id'))[0] || $('.input_ui_'+$(this).attr('selection_i__id')).length==1){
...
function go_next(do_skip){
    ...
    if (js_n___7712.includes(focus_i__type)){
        ...
        $(".this_selector").each(function () {
            ...
            if ($('.this_selector_'+selection_i__id_this+' i').hasClass('fa-square-check') || $(".this_selector").count()==1) {
