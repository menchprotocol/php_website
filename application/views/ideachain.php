...
foreach ($this->config->item('players___33292') as $playerid1 => $m1) {
    ...
    if($playerid1==28956){
        ...
        echo '<table class="table table-sm maxout center" style="width: 100%; table-layout: fixed; margin-bottom: 21px; margin-top: -89px;"><tr>';
        echo '<td style="width: 16.66%; text-align: center;">&nbsp;</td>';
        echo '<td style="width: 16.66%; text-align: center;">&nbsp;</td>';
        echo '<td style="width: 16.66%; text-align: center;" class="appender_32292"><i class="fas fa-rotate-left rotate90"></i></td>';
        echo '<td style="width: 16.66%; text-align: center;" class="appender_4486"><i class="fas fa-rotate-right rotate270"></i></td>';
        echo '<td style="width: 16.66%; text-align: center;">&nbsp;</td>';
        echo '<td style="width: 16.66%; text-align: center;">&nbsp;</td>';
        echo '</tr><tr>';
        echo '<td style="width: 16.66%; text-align: center;">&nbsp;</td>';
