...
<div class="section text-center">
    ...
    <div class="features testimonials" style="display:none;">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="info">
                    <p>I can't believe how much I've gotten done in your Bootcamp. I thought for sure I'd run out of
                        steam after 4 or 6 weeks, but you've actually created an environment that's giving me more and
                        more energy every week you put forward a new challenge. Amazing. So much gratitude to you.</p>
                    <h4>Donna Barker</h4>
                </div>
            </div>
            <div class="col-md-4">
                <div class="info">
                    <p>There are SO many things I've wanted to do for SO long that had me scared and overwhelmed. had no
                        idea where to begin. Your weekly assignments; your reminders, and your OH SO incredible emails
                        chock-full of help I'm just so very grateful ... SO BIG THANK YOU! Looking forward to doing more
                        of your Bootcamps!</p>
            ...
            <div class="col-md-4">
                <div class="info">
                    <p>It seems silly but I've bought $2000+ courses on the same topic and I haven't done anything
                        useful with them yet. Those online courses that I'm in are FILLED with modules and videos and it
                        seems like such a daunting Step to start. I think the simple style of your Bootcamp is what's
                        bringing me into action.</p>
                    <h4>Tina Huynh</h4>
                </div>
            </div>
