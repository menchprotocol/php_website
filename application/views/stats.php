        ...
        foreach ($this->config->item('users___' . $focus_list) as $userid3 => $m3) {
            ...
            if ($is_chain) {
                ...
                if($focus_chain_group>0 && (!$last_group_displayed || $last_group_displayed!=$focus_chain_group)){
                    ...
                    echo '<td style="text-align: center; padding: 8px 0;"><a href="' . view_memory(42903, 42902) . $users___3470452[$last_group_displayed]['m__handle'] . '"><span class="icon-block-sm grey">' . $users___3470452[$last_group_displayed]['m__cover'] . '</span></a><a href="' . view_app_chain(3445693) . '?chainusertype=' . join(',', $this->config->item('userids___'.$last_group_displayed)) . '&chainvoid=0'  . '" class="card_count_' . $focus_chain_group . ' grey"><i class="fas fa-yin-yang fa-spin"></i></a> <a href="' . view_memory(42903, 42902) . $users___3470452[$last_group_displayed]['m__handle'] . '" class="dotted_under grey" data-toggle="tooltip" data-placement="top" title="' . $users___3470452[$last_group_displayed]['m__message'] . '">' . $users___3470452[$last_group_displayed]['m__name'] . '</a>:</td>';
                    echo '</tr>';
