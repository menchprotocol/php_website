...
echo '<h2><a href="' . view_app_chain(3445693) . '?chainvoid=0"><span class="card_count_4341" style="min-width:111px; display: inline-block; text-align: center;"><i class="fas fa-yin-yang fa-spin"></i></span></a><span data-toggle="tooltip" data-placement="top" title="' . $users___11035[33292]['m__message'] . '"> ' . $users___11035[33292]['m__cover'] . ' <a href="/@' . $users___11035[33292]['m__handle'] . '">' . $users___11035[33292]['m__name'] . '</a>:&nbsp;<i class="fas fa-info-circle"></i></span></h2>';
...
foreach ($this->config->item('users___33292') as $userid1 => $m1) {
    ...
    if ($userid1 == 1309754) {
        //Voided
        echo '<div class="mid-text-line compact-midline voidstats grey"><span><a href="' . view_app_chain(3445693) . '?chainvoid=1" class="card_count_' . $userid1 . '"><i class="fas fa-yin-yang fa-spin"></i></a><span data-toggle="tooltip" data-placement="top" title="' . $m1['m__message'] . '">' . $m1['m__cover'] . '</span><a href="/@' . $m1['m__handle'] . '">' . $m1['m__name'] . '</a></span></div>';
        continue;
