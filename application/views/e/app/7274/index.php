...
echo '<textarea style="background-color:#FFFFFF; color:#222222 !important; padding:20px; font-family: monospace; font-size:0.8em; height:377px; width: 100%; border-radius: 10px;">';
