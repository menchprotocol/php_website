...
echo '<div><a class="controller-nav btn btn-lrg btn-discover go-next" href="'.( $i__id > 0 ? '/x/x_start/'.$i__id : home_url() ).'">'.$e___11035[14521]['m__icon'].' '.$e___11035[14521]['m__title'].'</a></div>';
echo '</div>';
echo '</div>';
