    ...
    echo '<div class="score_range_box">
                <div class="form-group"
                    ...
                    <div class="input-group border">
                        <span class="input-group-addon addon-lean addon-grey" style="color:#111111; font-weight: 300;">Start at #</span>
                        ...
                        <span class="input-group-addon addon-lean addon-grey" style="color:#111111; font-weight: 300; border-left: 1px solid #999999;"> and go </span>
                        ...
                        <span class="input-group-addon addon-lean addon-grey" style="color:#111111; font-weight: 300; border-left: 1px solid #999999; border-right:0px solid #FFF;"> levels deep.</span>
                    </div>
                </div>
