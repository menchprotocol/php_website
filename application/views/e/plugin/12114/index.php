...
$html_message .= '<div style="padding-bottom:10px;"><b style="min-width:30px; text-align: center; display: inline-block;">'.extract_icon_color($e___12467[12273]['m_icon'], true).'</b><b style="min-width:48px; display: inline-block;">'.( $i_coins_growth_rate >= 0 ? '+' : '-' ).$i_coins_growth_rate.'%</b><span style="text-decoration:none;">'.view_number($i_coins_last_week[0]['totals']).' '.$e___12467[12273]['m_title'].'</span></div>';

$html_message .= '<div style="padding-bottom:10px;"><b style="min-width:30px; text-align: center; display: inline-block;">'.extract_icon_color($e___12467[12274]['m_icon'], true).'</b><b style="min-width:48px; display: inline-block;">'.( $e_coins_growth_rate >= 0 ? '+' : '-' ).$e_coins_growth_rate.'%</b><span style="text-decoration:none;">'.view_number($e_coins_last_week[0]['totals']).' '.$e___12467[12274]['m_title'].'</span></div>';
