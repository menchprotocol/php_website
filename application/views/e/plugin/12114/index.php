...
//Email Subject
$subject = '🟡 '.$sources__13355[12273]['m_name'].' '.( $i_coins_growth_rate > 0 ? '+' : ( $i_coins_growth_rate < 0 ? '-' : '' ) ).$i_coins_growth_rate.'% for the Week of '.date("M jS", $last_week_start_timestamp);
...
$html_message .= '<div style="padding-bottom:10px;"><b style="min-width:30px; text-align: center; display: inline-block;">🔵</b><b style="min-width:55px; display: inline-block;">'.( $e_coins_growth_rate >= 0 ? '+' : '-' ).$e_coins_growth_rate.'%</b><span style="min-width:55px; display: inline-block;">(<span title="'.number_format($e_coins_last_week[0]['totals'], 0).'" style="border-bottom:1px dotted #999999;">'.view_number($e_coins_last_week[0]['totals']).'</span>)</span><a href="'.$this->config->item('base_url').'/@" target="_blank" style="color: #0000FF; font-weight:bold; text-decoration:none;">'.$sources__13355[12274]['m_name'].' &raquo;</a></div>';

$html_message .= '<div style="padding-bottom:10px;"><b style="min-width:30px; text-align: center; display: inline-block;">🟡</b><b style="min-width:55px; display: inline-block;">'.( $i_coins_growth_rate >= 0 ? '+' : '-' ).$i_coins_growth_rate.'%</b><span style="min-width:55px; display: inline-block;">(<span title="'.number_format($i_coins_last_week[0]['totals'], 0).'" style="border-bottom:1px dotted #999999;">'.view_number($i_coins_last_week[0]['totals']).'</span>)</span><a href="'.$this->config->item('base_url').'/~" target="_blank" style="color: #ffd500; font-weight:bold; text-decoration:none;">'.$sources__13355[12273]['m_name'].' &raquo;</a></div>';

$html_message .= '<div style="padding-bottom:10px;"><b style="min-width:30px; text-align: center; display: inline-block;">🔴</b><b style="min-width:55px; display: inline-block;">'.( $x_coins_growth_rate >= 0 ? '+' : '-' ).$x_coins_growth_rate.'%</b><span style="min-width:55px; display: inline-block;">(<span title="'.number_format($x_coins_last_week[0]['totals'], 0).'" style="border-bottom:1px dotted #999999;">'.view_number($x_coins_last_week[0]['totals']).'</span>)</span><a href="'.$this->config->item('base_url').'" target="_blank" style="color: #FF0000; font-weight:bold; text-decoration:none;">'.$sources__13355[6255]['m_name'].' &raquo;</a></div>';

$html_message .= '<div style="padding-bottom:10px;"><b style="min-width:30px; text-align: center; display: inline-block;">📖</b><b style="min-width:55px; display: inline-block;">'.( $interactions_discoveries_growth_rate >= 0 ? '+' : '-' ).$interactions_discoveries_growth_rate.'%</b><span style="min-width:55px; display: inline-block;">(<span title="'.number_format($interactions_discoveries_last_week[0]['totals'], 0).'" style="border-bottom:1px dotted #999999;">'.view_number($interactions_discoveries_last_week[0]['totals']).'</span>)</span><a href="'.$this->config->item('base_url').'/x" target="_blank" style="color: #000000; font-weight:bold; text-decoration:none;">'.$sources__13355[13362]['m_name'].' &raquo;</a></div>';
