...
echo '<div class="form-group" style="max-width:550px; margin:1px 0 10px; display: inline-block;">
                    <div class="input-group border">
                        ...
                        <input style="padding-left:3px; min-width:56px;" type="number" placeholder="7766" min="1" step="1" name="i__id" id="i__id" value="'.$_GET['i__id'].'" class="form-control">
                        <span class="input-group-addon addon-lean addon-grey" style="color:#000000; font-weight: 300;">& Chart Columns for #</span>

                        <input style="padding-left:3px; min-width:56px;" type="text" placeholder="123,345,456" name="i__list_ids" id="i__list_ids" value="'.$_GET['i__list_ids'].'" class="form-control">
