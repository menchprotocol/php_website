...
if(!count($e_query)){
    echo 'IDEA: '.nl2br(print_r($this->I_model->match_x_status($session_source['e__id'], $i_query), true)).'<hr />';
}

if(!count($i_query)){
    echo 'SOURCE: '.nl2br(print_r($this->E_model->match_x_status($session_source['e__id'], $e_query), true)).'<hr />';
}