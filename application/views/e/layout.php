            ...
            if($counter>0){
                ...
                foreach($i_notes_query as $count => $i_notes) {
                    ...
                    if($x__type==12896){
                        ...
                        //Saved IDEA
                        $focus_tab .= view_i_x($i_notes, 0 /* Unlocked */, null, true);


                    } else {
                        $focus_tab .= view_i_x($i_notes, 0 /* Unlocked */); //Inputs when it used to use view_i() : 0, false, false, $i_notes['x__message'], null, false
                    }
