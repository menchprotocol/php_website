        ...
        if(in_array(11040 , $m['m_profile'])){
            ...
            if($superpower_10939){
                ...
                if($source_is_e){
                    ...
                    $focus_tab .= '<div class="headline '.superpower_active(12700).'"><span class="icon-block">' . $e___11035[10573]['m_icon'] . '</span>' . $e___11035[10573]['m_title'] . '</div>';
            ...
            //ACCOUNT SETTING
            //$focus_tab .= '<div class="headline"><span class="icon-block">'.$m['m_icon'].'</span>'.$m['m_title'].'</div>';
            $focus_tab .= '<div class="accordion" id="MyAccountAccordion" style="margin-bottom:41px;">';
...
<div class="card-body">';
                ...
                if ($acc_e__id == 12289) {
                  ...
                  <a href="javascript:void(0)" onclick="account_toggle_all(0)" class="btn btn-fad"><i class="fas fa-toggle-off"></i></a>
                    ...
                    if(!$superpowers_unlocked){
                        ...
                        $focus_tab .= '<div class="msg alert alert-warning no-margin"><span class="icon-block"><i class="fas fa-exclamation-circle source"></i></span>No superpowers unlocked yet.</div>';
                    }
        ...
        $tab_nav .= '<li class="nav-item"><a class="nav-x tab-nav-11089 tab-head-'.$x__type.' '.( $default_active ? ' active ' : '' ).extract_icon_color($m['m_icon']).'" href="javascript:void(0);" onclick="loadtab(11089, '.$x__type.')" title="'.$m['m_title'].'" data-toggle="tooltip" data-placement="top">&nbsp;'.$m['m_icon'].'&nbsp;<span class="en-type-counter-'.$x__type.'">'.view_number($counter).( intval($counter) ? '&nbsp;' : '' ).'</span></a></li>';
