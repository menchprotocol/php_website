...
<div class="container">
    ...
    foreach($profiles as $count => $e_profile) {
        ...
        if(!$hide && $count==$show_max){
            $hide = true;
            echo '<div class="load-more montserrat list-group-item itemsource no-left-padding see_all_11030"><a href="javascript:void(0);" onclick="$(\'.see_all_11030\').toggleClass(\'hidden\')"><span class="icon-block"><i class="far fa-plus-circle source"></i></span><b class="montserrat source">FULL PROFILE<span class="'.superpower_active(13422).'"> ['.count($profiles).']</span></b></a></div>';
