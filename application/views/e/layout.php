        ...
        if(in_array(11040 , $m['m_profile'])){
            ...
            if($source_is_e){
                ...
                if(!superpower_assigned(10939)){
                    ...
                    $focus_tab .= '<div class="msg alert alert-warning" role="alert" style="text-decoration: none;"><span class="icon-block">'.$e___11035[10939]['m_icon'].'</span><a href="'.config_var(10939).'">'.$e___11035[10939]['m_title'].'<span class="icon-block"><i class="fas fa-arrow-right"></i></span></a><div>'.$e___11035[10939]['m_message'].'</div></div>';
            ...
            if($source_is_e){
                ...
                if(count($featured_i)){
                    $focus_tab .= '<div class="headline top-margin">'.$e___11035[13813]['m_title'].'</div>';
                ...
                if ($acc_e__id == 12289) {
                  ...
                  <a href="javascript:void(0)" onclick="account_toggle_all(0)" class="btn btn-fad"><i class="fas fa-toggle-off"></i></a>
                    ...
                    if(!$superpowers_unlocked){
                        ...
                        $focus_tab .= '<div class="msg alert alert-info no-margin"><span class="icon-block"><i class="fas fa-exclamation-circle source"></i></span>No superpowers unlocked yet. <a href="'.config_var(10939).'">Get Started<span class="icon-block"><i class="fas fa-arrow-right"></i></span></a></div>';
                    }
