        ...
        if(in_array(11040 , $m['m__profile'])){
                ...
                if($source_is_e){
                    ...
                    if(count($i_bookmarks) > 0){
                        ...
                        foreach($i_bookmarks as $item){
                            ...
                            $ui .= view_i_cover(10573, $item, null, $e);
                        }
                        $ui .= '</div>';
            ...
            if(count($list_i)){
                ...
                foreach($list_i as $count => $item){
                    ...
                    $ui .= view_i_cover(13550, $item, ( $show_message ? $this->X_model->message_send($item['x__message'], true) : null), $e);
                }
                $ui .= '</div>';
