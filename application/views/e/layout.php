...
<div class="card-body">';
        ...
        $tab_nav .= '<li class="nav-item"><a class="nav-x tab-nav-11089 tab-head-'.$x__type.' '.( $default_active ? ' active ' : '' ).extract_icon_color($m['m_icon']).'" href="javascript:void(0);" onclick="loadtab(11089, '.$x__type.')">'.$m['m_icon'].' <span class="en-type-counter-'.$x__type.'">'.view_number($counter).'</span><span class="hidden"><span class="show-max-active">&nbsp;'.$m['m_title'].'</span></span></a></li>';
