...
echo '<h1 style="padding-top:5px;"><span class="icon-block">'.view_e__icon($e___11035[6287]['m__icon']).'</span>'.count($this->config->item('e___6287')).' '.$e___11035[6287]['m__title'].'</h1>';
