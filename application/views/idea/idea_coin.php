...
echo '<div class="inline-block pull-right both-margin left-half-margin idea-discover '.( $is_public ? '' : ' hidden ' ).'"><a class="btn btn-discover btn-circle" href="/'.$in['in_id'].'" data-toggle="tooltip" data-placement="bottom" title="'.$en_all_11035[12750]['m_name'].'">'.$en_all_11035[12750]['m_icon'].'</a></div>';
