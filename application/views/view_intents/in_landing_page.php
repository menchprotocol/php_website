...
?>
    ...
    <div id="in_landing_page">
        ...
        <?php if (!$hide_subscribe) { ?>
            ...
            <div>
                <i class="fal fa-plus-circle learn_more_toggle"></i><i
                        class="fal fa-minus-circle learn_more_toggle hidden"></i> <a href="#learnMore"
                                                                                     onclick="$('.learn_more_toggle').toggleClass('hidden');"
                                                                                     style="text-decoration:underline; display: inline-block;">Learn
                    more</a>
                about Mench or
                <a href="/<?= $this->config->item('in_miner_start_id') ?>"
                   style="text-decoration:underline;  display: inline-block;">contribute &raquo;</a></div>
