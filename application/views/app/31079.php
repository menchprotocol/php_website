...
function referral_line($i){
    ...
    <div class="d-flex w-100 justify-content-between">
      ...
      '.( !$is_locked ? '<small>'.( !$plays ? ' <a href="javascript:void(0);" onclick="delete_ref('.$i['i__id'].','.( isset($i['x__id']) ? $i['x__id'] : 0 ).')"><i class="fal fa-trash-alt"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' : '' ).'<a href="javascript:void(0);" onclick="edit_ref('.$i['i__id'].')"><i class="fal fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/~'.$i['i__id'].'"><i class="fal fa-cog"></i></a></small>' : '<i class="fal fa-lock"></i>' ).'
    </div>
