...
foreach(view_coins_i(11019, $_GET['i__id'], 1, false) as $referral_i){
    $views = view_coins_i(6255, $referral_i['i__id'], 0, false);
    $income = 45;
    ...
    <p class="mb-1"><span class="icon-block"><i class="fas fa-eye"></i></span> '.$views.( $income>0 ? : ' | <span class="icon-block"><i class="fas fa-dollar-sign"></i></span> '.$income ).'</p>
  </a>';
}
