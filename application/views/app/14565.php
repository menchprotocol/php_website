    ...
    if(count($is)){
        ...
        foreach($this->X_model->fetch(array(
            ...
            if(substr_count($msg, '//www.youtube.com/embed/')==1){
                //YouTube video link
                echo '<div class="video-frame vid-padding" style="text-align: center;"><a href="javascript:void(0)" onclick="video_play()"><i class="fad fa-play-circle" style="color:#FFFFFF; font-size:8em !important;"></i></a></div>';
    ...
    foreach($this->X_model->fetch(array(
        ...
        */
        ...
        if($list_body){
            ...
            $ui .= '<h4 style="padding-top: 3px; text-align:center;"><span class="halfbg" style="padding: 5px; font-size: 0.8em !important;">Nothing Yet...</span></h4>';
        }
