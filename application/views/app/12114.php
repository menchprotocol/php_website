...
foreach($this->config->item('e___42263') as $x__type => $m) {
    ...
    //Add to UI:
    $html_message .= '<div class="line"><span style="inline-block; width: 55px; text-align: right;">'.$growth.'</span><span class="icon-block">'.$m['m__cover'].'</span>'.view_number($unique).' '.$m['m__title'].'</div>';
