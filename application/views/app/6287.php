...
//List Regular Apps:
echo '<div class="extra_apps center" style="padding: 34px 0;"><a href="javascript:void(0)" onclick="$(\'.extra_apps\').toggleClass(\'hidden\');"><i class="fas fa-arrows-v"></i> SEE MORE</a></div>';
