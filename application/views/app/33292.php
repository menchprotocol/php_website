...
foreach($this->config->item('e___33292') as $e__id1 => $m1) {
    ...
    foreach($this->config->item('e___'.$e__id1) as $e__id2 => $m2) {
        ...
        foreach($this->config->item('e___'.map_primary_links($e__id2)) as $e__id3 => $m3) {
            ...
            echo '<td style="text-align: left;"><span class="icon-block-xxs">&nbsp;</span><span class="icon-block-xxs">'.$m3['m__cover'].'</span>'.$m3['m__title'].' <span class="advanced-stats hidden mench-coins" title="'.$e___11035[42225]['m__title'].'">'.( isset($e___42225[$e__id3]['m__message']) ? intval($e___42225[$e__id3]['m__message']).' <span class="last-right-col" title="'.$e___11035[42225]['m__title'].'">'.$e___11035[42225]['m__cover'].'</span>' : '' ).'</span><span class="last-right-col" title="'.$e___11035[42225]['m__title'].'"><b class="card_count_'.$e__id3.'"><i class="far fa-yin-yang fa-spin"></i></b></span></td>';
            echo '</tr>';
