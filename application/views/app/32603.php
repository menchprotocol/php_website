...
foreach($this->I_model->fetch(array(
    ...
    if(!$signed_idea){
        ...
        echo '<input type="email" class="border greybg main__title itemsetting" value="'.( isset($_POST['x_email']) ? $_POST['x_email'] : '' ).'" placeholder="" name="x_email" />';
        echo '<h4>Phone Number:</h4>';
        echo '<input type="text" class="border greybg main__title itemsetting" value="'.( isset($_POST['x_phone']) ? $_POST['x_phone'] : '' ).'" placeholder="" name="x_phone" />';
