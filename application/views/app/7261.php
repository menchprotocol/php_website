...
if(count($duplicates) > 0){
    ...
    foreach($duplicates as $in) {
        ...
        echo '<div><span data-toggle="tooltip" data-placement="right" title="'.$e___4737[$in['i__type']]['m__title'].': '.$e___4737[$in['i__type']]['m__message'].'">' . $e___4737[$in['i__type']]['m__cover'] . '</span> <a href="/~' . $in['i__id'] . '"><b>' . $in['i__message'] . '</b></a> #' . $in['i__id'] . '</div>';
    }
