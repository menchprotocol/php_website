...
if(isset($_POST['payment_status'])){
    ...
    if ($target_i__id > 0 && $i__id > 0 && $x__creator > 0 && count($next_is)) {
        ...
        if($pay_amount > 0){
            ...
            //Log Payment:
            $new_x = $this->X_model->mark_complete(( $is_pending ? 35572 /* Pending Payment */ : 26595 ), $x__creator, $target_i__id, $next_is[0], array(
            ...
            //Log Refund:
            $new_x = $this->X_model->mark_complete(( $is_pending ? 39597 /* Pending Refund */ : 31967 ), $x__creator, $target_i__id, $next_is[0], array(
