...
foreach($this->I_model->fetch(array(
    ...
    echo '<div>'.($count+1).')'.view_cache(7712 /* OR Ideas */, $in['i__type']).'<a href="'.view_memory(42903,33286).$in['i__hashtag'].'">'.view_i_title($in).'</a></div>';
    ...
    foreach($this->X_model->fetch(array(
        ...
        echo '<li>';
        echo '<a href="'.view_memory(42903,33286).$down_or['i__hashtag'].'">'.view_i_title($down_or).'</a>';
