...
if(isset($_GET['i__id'])){
    ...
    foreach($this->X_model->fetch(array(
        ...
        if(substr_count($msg, '//www.youtube.com/embed/')==1){
            //YouTube video link
            echo '<div class="video-frame" style="padding: 165px 0; text-align: center;"><a href="javascript:void(0)" onclick="video_play()"><i class="far fa-play-circle" style="color: #FFF; font-size:8em !important;"></i></a></div>';
