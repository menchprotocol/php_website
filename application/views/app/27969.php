...
if(isset($_GET['e__id'])){
    ...
    foreach($this->X_model->fetch(array(
        ...
        if($list_body){
            //Add this to the UI:
            $ui .= '<h4 style="padding-top: 21px; text-align:center;"><span class="halfbg" style="padding: 0 5px;">' .$header['e__title'] . ':</span></h4>';
    ...
    echo '<div class="doclear" style="padding-bottom:144px;">&nbsp;</div>';
