...
foreach($list_settings['query_string_filtered'] as $x){
    ...
    foreach($list_settings['column_i'] as $i_var){
        ...
        if(count($discoveries)){
            ...
            if($discoveries[0]['link_type']==26595 && $link_metadata['mc_gross']!=0 && strlen($link_metadata['txn_id'])>0){
                $i_content .= '<a href="https://www.paypal.com/activity/payment/'.$link_metadata['txn_id'].'" target="_blank" data-toggle="tooltip" data-placement="top" title="View Paypal Transaction"><i class="fab fa-paypal" style="font-size:1em !important;"></i></a> ';
            }
