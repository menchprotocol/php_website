...
if(superpower_unlocked()) {
    ...
    <script>
        ...
        function load_away(){
            $('.login-content').html('<div class="center"><span class="icon-block-xx"><i class="far fa-yin-yang fa-spin"></i></span></div>');
        }
        ...
        function verify_contact(){
            ...
            $('#email_check_next').html('<span class="icon-block-xx"><i class="far fa-yin-yang fa-spin"></i></span>');
        ...
        function contact_auth(){
            ...
            //Lock fields:
            code_checking = true;
            $('#code_check_next').html('<span class="icon-block-xx"><i class="far fa-yin-yang fa-spin"></i></span>');
    ...
    <div class="center-info">
        ...
        <div class="text-center platform-text"><?= get_domain('m__title') ?></div>
