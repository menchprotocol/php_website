    ...
    if(0 && !isset($_GET['active'])){
        ...
        <script type="text/javascript">
            ...
            function search_email(){
                ...
                $('#email_check_next').html('<span class="icon-block"><i class="far fa-yin-yang zq12274 fa-spin"></i></span>');
            ...
            function add_account(){
                ...
                //Lock fields:
                account_adding = true;
                $('#add_acount_next').html('<span class="icon-block"><i class="far fa-yin-yang zq12274 fa-spin"></i></span>');
            ...
            function e_signin_password(){
                ...
                $('#password_check_next').html('<span class="icon-block"><i class="far fa-yin-yang zq12274 fa-spin"></i></span>');
            ...
            function e_magic_email(){
                ...
                $('.magic_result').html('<div><span class="icon-block"><i class="far fa-yin-yang zq12274 fa-spin"></i></span>Sending Email...</div>');
