...
if(superpower_unlocked()) {
    ...
    <script>
        ...
        function load_away(){
            $('.login-content').html('<div class="center"><span class="icon-block-sm"><i class="far fa-yin-yang fa-spin"></i></span></div>');
        }
        ...
        function e_verify_contact(){
            ...
            $('#email_check_next').html('<span class="icon-block-sm"><i class="far fa-yin-yang fa-spin"></i></span>');
        ...
        function e_contact_auth(){
            ...
            //Lock fields:
            code_checking = true;
            $('#code_check_next').html('<span class="icon-block-sm"><i class="far fa-yin-yang fa-spin"></i></span>');
