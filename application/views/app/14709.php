...
if(!$member_e){
    ...
    if($completion_rate['completion_percentage'] < 100){
        ...
        //SAVE & NEXT
        echo '<div class="discover-controller"><div><a class="controller-nav btn btn-lrg btn-discover go-next top-margin" href="javascript:void();" onclick="save_feedback()">'.$e___14709[14721]['m__title'].' '.$e___14709[14721]['m__cover'].'</a></div></div>';
