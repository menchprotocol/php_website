...
if(!$is_u_request || isset($_GET['cron'])){
    ...
    echo '<textarea class="mono-space subscriber_data hidden" style="background-color:#FFFFFF; color:#000 !important; padding:3px; font-size:0.8em; height:218px; width: 100%; border-radius: 17px;">'.$message_list['full_list'].'</textarea>';
    echo '<textarea class="mono-space subscriber_data hidden" style="background-color:#FFFFFF; color:#000 !important; padding:3px; font-size:0.8em; height:218px; width: 100%; border-radius: 17px;">'.$message_list['email_list'].'</textarea>';
    ...
    echo '<div style="border:1px solid #000000; padding:8px; border-radius: 17px;">';
    ...
    echo '<input type="datetime-local" id="message_time" value="'.date('Y-m-d\TH:i', (time()+3600)).'" style="border:1px solid #000000; padding:8px; border-radius: 17px; margin-top:21px;">';
