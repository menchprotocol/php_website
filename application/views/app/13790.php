...
if(strlen($_GET['i__id'])){
    ...
    foreach($this->X_model->fetch(array(
        ...
        $body_content .= '<td style="padding-top: 5px;"><span class="icon-block-xxs">'.view_cover(12274,$x['e__cover'], true).'</span><a href="/@'.$x['e__id'].'" style="font-weight:bold;">'.$x['e__title'].'</a>'.$name.$plus_info.'</td>';
