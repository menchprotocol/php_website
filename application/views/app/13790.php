...
if(!isset($_GET['i__id']) || !$_GET['i__id']){
    ...
    if(!isset($_GET['csv'])){
        ...
        echo '<p class="center">Legend: <i class="fal fa-filter"></i> Apply filter <i class="fal fa-filter rotate180"></i> Apply Inverse filter <i class="fas fa-sort"></i> Sort by column</p>';
