...
if($icon_keyword){
    ...
    if(count($matching_results) > 0){
        ...
        foreach($matching_results as $count=>$en){
            ...
            echo '<td style="text-align: left;">'.view_cache(6177 /* Source Status */, $en['e__access'], true, 'right').' <span class="icon-block">'.view_cover(12274,$en['e__cover']).'</span><a href="/@'.$en['e__id'].'">'.$en['e__title'].'</a></td>';
            echo '</tr>';
