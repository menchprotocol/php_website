...
echo '<textarea class="mono-space" readonly style="background-color:#FFFFFF; color:#222222 !important; padding:5px; font-size:0.65em; height:377px; width: 100%; border-radius: 10px;">';
