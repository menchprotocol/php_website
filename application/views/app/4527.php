...
if($memory_detected){
    ...
    $n___7357 = array(30826, 4755, 6181);
    $n___7359 = array(6176);
    $n___32292 = array(32486, 4230, 32489, 33335, 32293, 32488, 32487);
...
//Show:
echo '<textarea class="mono-space" style="background-color:#FFFFFF; color:#000000 !important; padding:20px; font-size:0.8em; height:377px; width: 100%; border-radius: 13px;">'.$memory_text.'</textarea>';