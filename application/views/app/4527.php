...
//Show:
echo '<textarea class="mono-space" style="background-color:#FFFFFF; color:#000001 !important; padding:20px; font-size:0.8em; height:377px; width: 100%; border-radius: 0;">'.$memory_text.'</textarea>';