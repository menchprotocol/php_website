...
if ($x__player && $target_i__hashtag != $focus_i['i__hashtag']) {
    ...
    $find_previous = $this->Ledger->find_previous($x__player, $target_i__hashtag, $focus_i['i__id']);
    if (count($find_previous)) {
        ...
        foreach ($find_previous as $followings_i) {
            ...
            $query_subset = $this->Ledger->read(array(
...
//Progress?
if ($player_e) {
    $tree_progress = $this->Ledger->tree_progress($x__player, $target_i);
