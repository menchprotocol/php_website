...
if(!isset($_GET['i__id'])){
    ...
    if(!count($is)){
        ...
        foreach ($is_next = $this->X_model->fetch(array(
            ...
            echo '<h3 style="margin:13px 0; padding-left:5px; font-size:1.3em;"><a href="javascript:void(0);" onclick="$(\'.i_msg_'.$i['i__id'].'\').toggleClass(\'hidden\');" class="inner-content doblock">' . $i['i__title'] . '</a></h3>';
