...
echo '<div><a class="controller-nav btn btn-lrg btn-read go-next" href="javascript:void(0);" onclick="complete_setup()">'.$e___11035[14521]['m__title'].' '.$e___11035[14521]['m__icon'].'</a></div>';
echo '</div>';
