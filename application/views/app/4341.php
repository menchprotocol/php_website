...
<script>
    ...
    function x_4341(x_filters, x_joined_by, page_num){
        ...
        //Show spinner:
        $('#x_page_'+page_num).html('<div class="main__title center"><span class="icon-block-xs"><i class="far fa-yin-yang fa-spin"></i></span>' + js_view_shuffle_message(12694) +  '</div>').hide().fadeIn();
