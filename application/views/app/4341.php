...
<script>
    ...
    function check_i_e__privacy(){
        ...
        if($("#x__type").val()==4250){
            ...
            $(".e_privacy_filter").removeClass('hidden');
        }
    }
    ...
    function app_4341(x_filters, x_joined_by, page_num){
        ...
        //Show spinner:
        $('#x_page_'+page_num).html('<div class="css__title center"><span class="icon-block"><i class="fal fa-yin-yang fa-spin"></i></span>' + js_view_shuffle_message(12694) +  '</div>').hide().fadeIn();
