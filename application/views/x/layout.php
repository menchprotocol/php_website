...
if(!$in_my_x){
    ...
    if ($i_type_meet_requirement) {
        ...
        if(count($x_completes)){
            ...
            //Give Button option:
            $focus_tab .= '<div class="margin-top-down left-margin block"><a class="btn btn-x" href="javascript:void(0);" onclick="go_12211()">'.$e___11035[13524]['m_name'].' '.$e___11035[13524]['m_icon'].'</a></div>';
        }
...
if($in_my_x){
    ...
    //Current Idea:
    echo '<div class="list-group-item no-padding itemdiscover">'.$main_title.'</div>';
