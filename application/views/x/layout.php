...
if(count($this->X_model->fetch(array(
    ...
    echo '<div class="i_content padded"><div class="msg">Tip: Tapping on <span class="icon-block-xs e__icon_12896"><i class="far fa-bookmark discover"></i></span> will save this idea in your profile for easy future access.</div></div>';
}
