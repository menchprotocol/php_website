...
if($recipient_source['e__id']){
    ...
    if ($in_my_discoveries) {
        ...
        // % DONE
        $completion_rate = $this->X_model->completion_progress($recipient_source['e__id'], $i_focus);
...
if(!$in_my_discoveries){
    ...
    if ($i_type_meet_requirement) {
        ...
        if(!count($discovery_completes)) {
            ...
            echo '<div class="previous_answer">'.$this->X_model->message_send($discovery_completes[0]['x__message']).'</div>';
