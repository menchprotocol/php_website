...
$show_nav = $superpower_10939 || !$in_my_x || $in_my_discoveries;
$x_completes = array();
        ...
        if(i_is_startable($i_focus)){
            ...
            if(count($top_startable)){
                ...
                foreach($top_startable as $start_i){
                    ...
                    echo '<div><a class="btn btn-lrg btn-discover" href="/'.$start_i['i__id'].'">'.$start_i['i__title'].' '.$e___11035[14022]['m__icon'].'</a></div>';
                }
