...
if(count($this->X_model->fetch(array(
    ...
    echo '<div class="i_content padded"><div class="msg">Tip: Hit <span class="icon-block-xs e__icon_12896"><i class="far fa-bookmark discover"></i></span> to save this idea in your profile for easy access later-on.</div></div>';
}
