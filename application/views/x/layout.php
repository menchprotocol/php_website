    ...
    */
    ...
    if($x__type==13563){
        ...
        if($in_my_x) {
            ...
            //NEXT IDEAS
            $focus_tab .= view_i_list($in_my_x, $i_focus, $is_next, $user_e, ( $time_estimate ? '<div class="i_estimates">'.$time_estimate.'</div>' : $e___11035[13542]['m_title'] ));
        ...
        $focus_tab .= '<div class="i_content padded"><div class="msg">This idea has been discovered '.number_format($counter, 0).' time'.view__s($counter).'.</div></div>';
