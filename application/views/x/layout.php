...
if($in_my_x /* && !count($sitemap_items) */ && !$i_completed){
    ...
    echo '<div class="alert alert-info no-margin space-left">To save this idea for easy future access, tap<span class="icon-block-xs e__icon_12896"><i class="far fa-bookmark discover"></i></span></div>';
