    ...
    echo '<div class="score_range_box">
            <div class="form-group label-floating is-empty"
                ...
                <div class="input-group border">
                    ...
                    <span class="input-group-addon addon-lean addon-grey" style="color:#000000; font-weight: 300; border-left: 1px solid #ccc;"> and go </span>
                    ...
                    <span class="input-group-addon addon-lean addon-grey" style="color:#000000; font-weight: 300; border-left: 1px solid #ccc; border-right:0px solid #FFF;"> levels deep.</span>
                </div>
            </div>
