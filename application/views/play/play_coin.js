    ...
    $(element_focus + ' .new-player-input')
        ...
        templates: {
            ...
            header: function (data) {
                if (!data.isEmpty) {
                    return '<a href="javascript:en_add_or_link(0,'+is_en_parent+')" class="suggestion"><span class="icon-block-sm"><i class="fad fa-plus-circle add-plus play"></i></span><b>' + data.query.toUpperCase() + '</b></a>';
                }
            },
            empty: function (data) {
                return '<a href="javascript:en_add_or_link(0,'+is_en_parent+')" class="suggestion"><span class="icon-block-sm"><i class="fad fa-plus-circle add-plus play"></i></span><b>' + data.query.toUpperCase() + '</b></a>';
