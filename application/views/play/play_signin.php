...
<div class="container center-info">
    ...
    if($referrer_in_id > 0){
        ...
        if(count($ins) > 0){
            echo '<p class="text-center montserrat doupper">TO READ <a href="/'.$referrer_in_id.'"><u>'.echo_in_title($ins[0]['in_title']).'</u></a> & UP TO '.config_var(11061).' IDEAS PER WEEK FOR FREE</p>';
        }
