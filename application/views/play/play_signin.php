...
<div class="container center-info">
    ...
    <div class="login-content" style="margin-top:50px;">
        ...
        <div id="step2" class="signup-steps hidden">
            ...
            <span id="messenger_sign" style="padding-left:5px; font-size:1em !important;" class="<?= ( $referrer_in_id > 0 ? ' hidden ' : '' ) ?>">OR <a href="javascript:void(0)" onclick="confirm_sign_on_messenger(<?= $referrer_in_id ?>)" class="dounderline">USE MESSENGER</a> <i class="fab fa-facebook-messenger play"></i></span>
        </div>
        ...
        <div id="step4" class="signup-steps hidden">
            ...
            <span id="step2buttons">
                <a href="javascript:void(0)" onclick="goto_step(2)" class="btn btn-play transparent pass btn-raised btn-round"><i class="fas fa-angle-left"></i></a>
                <a href="javascript:void(0)" onclick="add_account()" id="add_acount_next" class="btn btn-play pass btn-raised btn-round"><i class="fas fa-angle-right"></i></a>
            </span>
        ...
        <div id="step3" class="signup-steps hidden">
            ...
            <span id="step3buttons">
                <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" title="Go Back" onclick="goto_step(2)" class="btn btn-play transparent pass btn-raised btn-round"><i class="fas fa-angle-left"></i></a>
            ...
            <span style="padding-left:5px; font-size:0.9em !important;">OR <a href="javascript:void(0)" onclick="magicemail()" class="dounderline">MAGIC LINK</a> <i class="fas fa-envelope-open play"></i></span>
