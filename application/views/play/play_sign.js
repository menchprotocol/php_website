...
function search_email(){
    ...
    $.post("/play/singin_check_email", {
        ...
        if (data.status) {
            ...
            //Show errors:
            $('#email_errors').html('<i class="fad fa-exclamation-triangle"></i> Note: ' + data.message + '</b>').hide().fadeIn();
            $('#input_email').focus();
        }
    });
...
function add_account(){
    ...
    $.post("/play/sign_create_account", {
        ...
        if (data.status) {
            ...
            //Show errors:
            $('#new_account_errors').html('<i class="fad fa-exclamation-triangle"></i> Note: ' + data.message + '</b>').hide().fadeIn();
        }
...
function singin_check_password(){
    ...
    $.post("/play/singin_check_password", {
        ...
        if (data.status) {
            ...
            //Show errors:
            $('#password_errors').html('<i class="fad fa-exclamation-triangle"></i> Note: ' + data.message + '</b>').hide().fadeIn();
        }
    ...
    if (r == true) {
        ...
        $.post("/play/magicemail", {
            ...
            if (data.status) {
                ...
                //Show errors:
                $('.magic_result').html('<b style="color: #FF0000;"><i class="fad fa-exclamation-triangle"></i> Note: ' + data.message + '</b>').hide().fadeIn();
            }
        });
    }
}