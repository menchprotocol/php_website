...
<script src="/application/views/play/play_myaccount.js?v=v<?= config_var(11060) ?>" type="text/javascript"></script>
...
<div class="container">
    ...
    <a href="/play/<?= $session_en['en_id'] ?>" class="btn btn-play" style="margin: 20px 0;"><span class="icon-block"><i class="fas fa-angle-left"></i></span><?= $session_en['en_name'] ?></a>
