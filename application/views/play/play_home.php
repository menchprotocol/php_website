...
<div class="container">
    ...
    echo '<table class="table table-sm table-striped dotransparent tablepadded" style="margin-top:-10px;">';
    ...
    echo '<td class="idea fixedColumns MENCHcolumn3"><span class="idea"><span class="icon-block">' . $en_all_2738[4535]['m_icon'] . '</span><span class="montserrat" title="'.number_format($idea_coins[0]['total_coins'], 0).'">'.echo_number($idea_coins[0]['total_coins']).'</span><b class="block montserrat"><span class="icon-block show-max">&nbsp;</span>'.$en_all_2738[4535]['m_name'].'S</b></span></td>';
    echo '</tr>';
