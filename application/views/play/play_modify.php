...
<div class="container">
    ...
    //NAME
    echo '<h1 class="inline-block montserrat '.extract_icon_color($player['en_icon']).'"><span class="icon-block-xlg en-icon en_ui_icon_'.$player['en_id'].'">'.echo_en_icon($player['en_icon']).'</span> <span class="en_name_'.$player['en_id'].'">'.$player['en_name'].'</span></h1>';
