...
<div class="container">
    ...
    if(isset($session_en['en_id']) && $session_en['en_id']==$player['en_id']){
        echo '<a href="/play" class="btn btn-play btn-five inline-block" style="padding-top:10px;" data-toggle="tooltip" data-placement="bottom" title="'.$en_all_11035[4536]['m_desc'].'">'.$en_all_11035[4536]['m_icon'].' '.$en_all_11035[4536]['m_name'].'</a>';
    }
        ...
        foreach ($this->config->item('en_all_'.$en_id) as $en_id2 => $m2){
            ...
            if($en_id2==11030){
                ...
                $this_tab .= '<div id="new-parent" class="'.superpower_active(10983).'">
                    ...
                    <div class="algolia_search_pad hidden"><b class="montserrat"><span class="icon-block"><i class="far fa-search-plus"></i></span>Create, Search or Paste URL</b></div>
            </div>';
