...
function load_leaderboard(){
    //Show loading icon:
    $('#load_leaderboard').html('<div class="alert montserrat"><span class="icon-block"><i class="far fa-yin-yang fa-spin play"></i></span> LOADING...</div>');
...
function echo_js_suggestion(alg_obj){
    ...
    var obj_icon = ( parseInt(alg_obj.alg_obj_is_in) ? '<i class="fas fa-circle blog"></i>' : alg_obj.alg_obj_icon );
