...
foreach($this->config->item('players___33292') as $playerid1 => $m1) {
    ...
    echo '<div class="mid-text-line compact-midline"><span><b class="card_count_'.$playerid1.'"><i class="fas fa-yin-yang fa-spin"></i></b><span class="icon-block-sm">'.$m1['m__cover'].'</span> '.$m1['m__title'].':</span></div>';
