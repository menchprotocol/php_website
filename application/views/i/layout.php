...
//PREVIEW DISCOVERY
echo '<div class="inline-block pull-right both-margin" style="margin-right: 33px;"><a class="btn btn-discover" href="/'.$i_focus['i__id'].'" data-toggle="tooltip" data-placement="top" title="'.$e___11035[13562]['m_title'].'" style="font-size: 1em !important;"><span class="show-max">'.$e___11035[13562]['m_title'].' </span>'.$e___11035[13562]['m_icon'].'</a></div>';
...
$tab_group = 11018;
$tab_content = '';
echo '<ul class="nav nav-tabs nav-sm nav-idea">';
