...
echo view_input_text(4736, $i_focus['i__title'], $i_focus['i__id'], ($e_of_i && $is_active), 0, true, view_input_dropdown(4737, $i_focus['i__type'], 'idea', $e_of_i, false, $i_focus['i__id'])); //view_i_icon($i_focus)
echo '</div>';
