...
function i_add(i_x_id, is_parent, i_x_child_id) {
    ...
    add_to_list(sort_list_id, sort_handler, '<div id="tempLoader" class="list-group-item montserrat no-side-padding"><span class="icon-block"><i class="fas fa-yin-yang fa-spin idea"></i></span>' + js_view_message(12695) +  '</div>');
