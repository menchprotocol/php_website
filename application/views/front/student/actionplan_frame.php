        ...
        window.extAsyncInit = function() {
            ...
            MessengerExtensions.getContext('1782431902047009',
                ...
                function error(err){
                    ...
                    $("#page_content").html('<div class="alert alert-info" role="alert" style="line-height:110%;"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> To access your Action Plan you need to <a href="https://mench.co/login" target="_blank" style="font-weight:bold;">Login</a>. Use [Forgot Password] if you never logged in before.</div>');
