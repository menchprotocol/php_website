...
if($level==2){
    ...
    if($previous_on || $next_on){
        ...
        if($previous_on){
            echo '<a href="/my/actionplan/'.$admission['b_id'].'/'.$previous_intent['c_id'].'" class="btn btn-black" style="margin:0; padding-left:3px; padding-right:3px;"><i class="fa fa-arrow-left"></i> Previous</a>';
        }
        if($next_on){
            echo '<a href="/my/actionplan/'.$admission['b_id'].'/'.$next_intent['c_id'].'" class="btn btn-black" style="margin:0 0 0 4px; padding-left:3px; padding-right:3px;">Next <i class="fa fa-arrow-right"></i></a>';
        }
        echo '</div>';
    }
