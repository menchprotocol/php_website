...
foreach($bootcamps as $count=>$bootcamp){
    ...
    echo '<div class="col-sm-6 col-md-4">
			<div class="card card-product">
                ...
                echo '<div class="card-description"><b><i class="fa fa-calendar" aria-hidden="true"></i> '.count($bootcamp['c__child_intents']).' Weeks @ '.echo_hours(round($bootcamp['c__estimated_hours']/count($bootcamp['c__child_intents']))).'/Week</b></div>';
