...
<p class="home_line_2">7-Day Bootcamps ranging from <span style="display:inline-block;">$0-163/week</span> based on the support level you choose.</p>
<p class="home_line_2">New classes start every Monday. <span style="display:inline-block;">(in <span id="classes_start"></span> from now)</span></p>
<br />
