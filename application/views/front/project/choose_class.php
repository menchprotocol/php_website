...
<div class="section s1" style="display:block;">
	...
	foreach($active_classes as $class){
	    echo '<a href="/'.$project['b_url_key'].'/apply/'.$class['r_id'].'" class="list-group-item" style="padding:10px 5px 12px 10px;">';
	...
	<p>Or go back to the <a href="/<?= $project['b_url_key'] ?>">Project Page</a>.</p>
