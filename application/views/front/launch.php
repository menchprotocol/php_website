...
<div class="section text-center">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="info">
					...
					<h3 class="info-title">Create Project</h3>
			...
			<div class="col-md-4">
				<div class="info">
					...
					<p>Set a launch date and announce your Project. Make it open to anyone or create an application page to make sure participants meet a specific criteria. You set the rules and the cost. We take care of the technology.</p>
				</div>
			</div>
			<div class="col-md-4">
				<div class="info">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="info">
					...
					<p>People love challenges, especially when their friends join. You know what that means right? more participants, more reach, more business for you. Projects are one of the most effective lead generation solutions available.</p>
				</div>
			</div>
			<div class="col-md-4">
				<div class="info">
					...
					<p>Take your students on a journey of gaining tangible results that would transform their life. We'll give you the technology, knowledge and support you'd need to help your students accomplish the Project outcome once and for all.</p>
				</div>
			</div>
			<div class="col-md-4">
				<div class="info">
					...
					<p>A Project allows you to add a lucrative source of income. People are willing to pay a premium for content that helps them gain in-demand skills. At Mench you'll be able to command higher prices than for information-only products.</p>
				</div>
			</div>
		</div>
	</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="title" style="margin-top:100px;">Who Is It For?</h2>
        </div>
    </div>
    <div class="section text-center">
        <div class="features">
            <div class="row">
                <div class="col-md-4">
                    <div class="info">
                        <h2 class="title" style="margin-top:30px; line-height: 110%;">Online Instructors</h2>
                        <p style="min-height:200px;">Upgrade your online courses into Projects to empower your students to gain valuable skills by taking action. Earn ~50x or more per student by bundling personalized support with your content to dramatically increase student engagement.</p>
                    </div>
                </div>
                <div class="col-md-4">
				...
				*/ ?>
                ...
                <div class="col-md-4">
                    <div class="info">
                        <h2 class="title" style="margin-top:30px; line-height: 110%;">Field<br />Experts</h2>
                        <p style="min-height:200px;">Work with us to productize your expertise into an online Project that helps students gain your skills by taking action. Connect with others around the world interested in your knowledge, build a source of recurring revenue and transform lives.</p>
                    </div>
	...
	<div class="features">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="info">
					<p>I can't believe how much I've gotten done in your Project. I thought for sure I'd run out of steam after 4 or 6 weeks, but you've actually created an environment that's giving me more and more energy every week you put forward a new challenge. Amazing. So much gratitude to you.</p>
					<h4>Donna Barker</h4>
				</div>
			</div>
			<div class="col-md-4">
				<div class="info">
					<p>There are SO many things I've wanted to do for SO long that had me scared and overwhelmed. had no idea where to begin. Your weekly assignments; your reminders, and your OH SO incredible emails chock-full of help I'm just so very grateful! This 12-week Project got me started on something that's been in my "to do" plan for at least 5 years now. SO BIG THANK YOU! Looking forward to doing more of your Projects!</p>
