...
<script src="/application/views/tree/tree_bookmarks.js?v=v<?= config_var(11060) ?>" type="text/javascript"></script>
...
<div class="container">
    ...
    if(!$session_en){
        ...
        echo '<div style="padding:10px 0;"><a href="/source/sign?url=/tree" class="btn btn-tree montserrat">'.$en_all_11035[4269]['m_name'].'<span class="icon-block">'.$en_all_11035[4269]['m_icon'].'</span></a> to start treeting.</div>';

    } else {

        //Add New Tree:
        $superpower = 10939; //TREE PEN TO START

        if(superpower_assigned($superpower)) {

            echo '<div id="myTrees" class="list-group">';
            ...
            echo '<div class="list-group-item itemtree '.superpower_active($superpower).'" style="padding:5px 0;">
