...
if($handle_session['handleid']){
    ...
    js_php_redirect(( $hashtagstring ? guestlogin . view_memory(42903, 33286) . $hashtagstring : view_memory(42903,42902).$handle_session['handlestring'] ), 13);
    ...
    js_php_redirect(( $hashtagstring ? guestlogin . view_memory(42903, 33286) . $hashtagstring : view_memory(42903,42902).$handle_result['e']['handlestring'] ), 13);
