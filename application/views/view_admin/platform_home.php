...
<div class="row" style="margin:0; padding: 0;">
    ...
    <div id="stats_intents_box" class="col-md-6 bottom-spacing">
        <div class="large-stat"><a href="javascript:void(0);" onclick="load_extra_stats('intents')" class="yellow"><?= $en_all_4534[4535]['m_icon'] ?> <span class="extended_stats"><i class="fas fa-spinner fa-spin"></i></span> <span class="substitle"><?= $en_all_4534[4535]['m_name'] ?> <i class="extra_stat_content fal fa-plus-circle"></i><i class="extra_stat_content fal fa-minus-circle hidden"></i></span></a></div>
        <div class="load_stats_box extra_stat_content hidden"></div>
    </div>


    <div id="stats_entities_box" class="col-md-6 bottom-spacing">
        <div class="large-stat"><a href="javascript:void(0);" onclick="load_extra_stats('entities')" class="blue"><?= $en_all_4534[4536]['m_icon'] ?> <span class="extended_stats"><i class="fas fa-spinner fa-spin"></i></span> <span class="substitle"><?= $en_all_4534[4536]['m_name'] ?> <i class="extra_stat_content fal fa-plus-circle"></i><i class="extra_stat_content fal fa-minus-circle hidden"></i></span></a></div>
        <div class="load_stats_box extra_stat_content hidden"></div>
    </div>
