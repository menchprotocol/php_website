        ...
        <div class="row justify-content">
            <table class="platform-navigation">
                <tr>
                    ...
                    echo '<a href="/">'.( strlen($domain_cover) ? '<span class="icon-block platform-logo source_cover source_cover_mini mini_6197_'.$website_id.'">'.view_cover(12274, $domain_logo, 1).'</span>' : '<span style="float: left; width: 5px; display: block;">&nbsp;</span>') . '<b class="css__title text-logo text__6197_'.$website_id.'" style="'.( filter_var($domain_logo, FILTER_VALIDATE_URL) ? 'padding-top:0px;' : 'padding-top:5px;' ).'">'.get_domain('m__title').'</b>'.'</a>';
