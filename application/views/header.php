            ...
            <table class="platform-navigation">
                <tr>
                    ...
                    if($member_e && $superpower_28651) {
                        ...
                        $echo_left_nav .= '<td class="block-x user_nav_box">';
                        $echo_left_nav .= '<a href="/@'.$member_e['e__id'].'" data-toggle="tooltip" data-placement="right" title="'.$member_e['e__title'].'" style="margin-left: 0;" class="menu_click source_cover source_cover-mini">'.view_cover(12274,$member_e['e__cover'], 1).'</a>';
                        $echo_left_nav .= '</td>';
