            ...
            <table class="mench-navigation">
                <tr>
                    ...
                    if($user_e){
                        ...
                        //My Source
                        echo '<a href="'.home_url($current_mench['c__id']).'"><span class="mench-circle e_ui_icon_'.$user_e['e__id'].'">'.$user_e['e__icon'].'</span><span class="montserrat text-logo"><b class="text__6197_'.$user_e['e__id'].'">'.$user_e['e__title'].'</b>'.( '@'.$user_e['e__id']==$first_segment ? '' : view_coins_e($current_mench['c__id'], $user_e['e__id']) ).'</span></a>';
