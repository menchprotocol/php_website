            ...
            <table class="platform-navigation">
                <tr>
                    ...
                    if($member_e && $superpower_28651) {
                        ...
                        $echo_left_nav .= '<td class="block-x user_nav_box">';
                        $echo_left_nav .= '<a href="/@'.$member_e['e__id'].'" data-toggle="tooltip" data-placement="right" title="'.$member_e['e__title'].'" style="margin-left: 0;" class="menu_click source_cover source_cover_mini">'.view_cover(12274,$member_e['e__cover'], 1).'</a>';
                        $echo_left_nav .= '</td>';
                        ...
                        //Login:
                        //$echo_left_nav .= '<td class="block-x user_nav_box">';
                        //$echo_left_nav .= '<a href="/-4269'.$login_url_path.'" style="margin-left: 0;" class="icon-block">'.$e___11035[4269]['m__cover'].'</a>';
                        //$echo_left_nav .= '</td>';
                    ...
                    echo '<a href="/">'.( strlen($domain_cover) ? '<span class="icon-block platform-logo source_cover source_cover_mini mini_6197_'.get_domain_setting(0).'">'.view_cover(12274, one_two_explode('"','"',get_domain('m__cover')), 1).'</span>' : '<span style="float: left; width: 5px; display: block;">&nbsp;</span>') . '<b class="css__title text-logo text__6197_'.$base_source.'">'.get_domain('m__title').'</b>'.'</a>';
