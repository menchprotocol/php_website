            ...
            <table class="mench-navigation">
                <tr>
                    ...
                    if($user_e){
                        ...
                        //My Source
                        echo '<a href="'.home_url($current_mench['c__id']).'"><span class="mench-circle e_ui_icon_'.$user_e['e__id'].'">'.$user_e['e__icon'].'</span><span class="montserrat text-logo" '.( $superpower_10939 ? '' : ' style="width: calc(100% - 43px);" ' ).'><b class="text__6197_'.$user_e['e__id'].'">'.$user_e['e__title'].'</b><span style="font-size: 0.75em; margin-left: 5px; display: inline-block;">'.view_coins_e(( '@'.$user_e['e__id']==$first_segment && !$superpower_10939 ? 6255 : $current_mench['c__id'] ), $user_e['e__id']).'</span></span></a>';
