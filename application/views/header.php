...
<head>
    ...
    <link href="/application/views/global.css?v=dir<?= view_memory(6404,11060) ?>" rel="stylesheet"/>
    <script src="/application/views/global.js?v=dir<?= view_memory(6404,11060) ?>" type="text/javascript"></script>
