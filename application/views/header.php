                ...
                <tr>
                    ...
                    <td>
                        <div class="supwerpower_view">
                            ...
                            <span class=""><span class="mench-logo mench-text montserrat search-toggle <?= ( isset($basic_header) ? ' hidden ' : '' ) ?>">ME<?= ( count($this->session->userdata('assigned_superpowers_en_ids')) ? '<a href="javascript:void(0);" onclick="$(\'.supwerpower_view\').toggleClass(\'hidden\');" style="text-decoration: none;">N</a>' : 'N' ) ?>CH</span></span>
