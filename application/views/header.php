  ...
  gtag(\'config\', \''.$google_analytics_code.'\');
    ...
    ';
      ...
      background-size: cover !important;
            ...
            echo ' .halfbg, .msg>span { background: rgba(0, 0, 0, 0.69) !important; border-radius: 0.21px; } ';
            echo ' .fixed-top { background: rgba(21,21,21, 1) !important; border-radius: 0.21px; } ';
