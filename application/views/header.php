                    ...
                    <tr>
                        ...
                        foreach($this->config->item('en_all_2738') as $en_id => $m){
                            ...
                            if($identifier=='play'){
                                ...
                                //Player Coins:
                                echo '<span class="parent-icon icon-block icon_en_'.$session_en['en_id'].'">'.$session_en['en_icon'].'</span>';
                                echo '<span class="montserrat en_name_first_'.$session_en['en_id'].'">'.one_two_explode('',' ',$session_en['en_name']).'</span>';
