...
<script>
  ...
  gtag(\'config\', \''.$google_analytics_code.'\');
    ...
    <link href="/application/views/global.css?v=dir3<?= '2' //$this->config->item('cache_buster') ?>" rel="stylesheet"/>
    <script src="/application/views/global.js?v=dir3<?= '3' //$this->config->item('cache_buster') ?>" type="text/javascript"></script>
        ...
        <div class="row justify-content">
            <table class="platform-navigation">
                <tr>
                    ...
                    echo '<span class="icon-block source_cover source_cover_mini menu-icon">' . ( $member_e ? view_cover(12274,$member_e['e__cover'], 1) : $e___13479[$menu_type]['m__cover'] ) .'</span>';
                    echo '</button>';
