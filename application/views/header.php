        ...
        <div class="row">
            <table class="platform-navigation">
                <tr>
                    ...
                    //SEARCH
                    echo '<div class="left_nav search_nav hidden"><form id="searchFrontForm"><input class="form-control algolia_search" type="search" id="top_search" data-lpignore="true" placeholder="'.$e___11035[7256]['m__title'].' ['.$_SERVER['HTTP_HOST'].'/'.$_SERVER['SERVER_NAME'].']"></form></div>';
