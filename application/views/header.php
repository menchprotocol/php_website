            ...
            <table class="platform-navigation">
                <tr>
                    ...
                    if(superpower_unlocked(10939)){
                        ...
                        echo '<td class="block-x"><a href="javascript:void(0);" onclick="editor_load_e(0,0)" style="margin-left: 0;" title="'.$e___11035[14055]['m__title'].'">'.$e___11035[14055]['m__cover'].'</a></td>'; //TODO fix icon reference
                    }
