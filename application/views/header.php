...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans|Quicksand:700|Roboto+Mono:500|Montserrat:800|Rubik|Bitter:800|Roboto+Slab:400|Righteous|Rosarivo|Lato&display=swap" rel="stylesheet">
        ...
        <div class="row justify-content-center">
            <table class="platform-navigation">
                <tr>
                    ...
                    $site_logo = ( $domain_cover!='<i class="fas fa-circle zq12274"></i>' ? '<span class="icon-block platform-logo mini_6197_'.get_domain_setting(0).'">'.get_domain('m__cover').'</span>' : '<span style="float: left; width: 5px; display: block;">&nbsp;</span>');
