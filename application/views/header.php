                ...
                <tr>
                    ...
                    if ($user_e) {
                        if($first_segment!='@'.$user_e['e__id']){
                            ...
                            echo '<a href="'.home_url().'" class="montserrat icon-tweak '.extract_icon_color($user_e['e__icon']).'"><span class="icon-block e_ui_icon_'.$user_e['e__id'].'">'.$user_e['e__icon'].'</span><span class="text__6197_'.$user_e['e__id'].' name-block">'.$user_e['e__title'].'</span></a>';
                            echo '</div>';
                        } else {
