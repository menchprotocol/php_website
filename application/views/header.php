                    ...
                    if (!$user_e) {
                        ...
                        foreach($this->config->item('e___12500') as $x__type => $m) {
                            ...
                            if($x__type==11060) {
                                ...
                                //JUST SHOW VERSION:
                                echo '<div class="dropdown-item montserrat doupper '.extract_icon_color($m['m_icon']).( count($superpower_actives) ? superpower_active(end($superpower_actives)) : '' ).'" title="'.$m['m_title'].'"><span class="icon-block">'.$m['m_icon'].'</span>'.config_var(11060).'</div>';
                                continue;
