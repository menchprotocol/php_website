            ...
            <table class="mench-navigation">
                <tr>
                    ...
                    if ($user_e) {
                        ...
                        echo '<div class="mench_nav left_nav" style="padding: 11px 0 0;"><a href="'.home_url().'" class="montserrat '.extract_icon_color($user_e['e__icon']).'"><span class="icon-block e_ui_icon_'.$user_e['e__id'].'">'.$user_e['e__icon'].'</span><span style="font-size: 1.2em;">'.$first_word.'</span></a></div>';//<span class="show-max"> '.join(' ', $title_words).'</span>
                    } else {
