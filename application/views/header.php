...
<head>
    ...
    echo ' var js_pl_name = \'' . ( $member_e ? stripslashes($member_e['e__title']) : '' ) . '\'; ';
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans|Quicksand:700|Roboto+Mono:500|Montserrat:800|Rubik|Bitter:800|Roboto+Slab:400|Righteous|Lato&display=swap" rel="stylesheet">
    ...
    //if(!$superpower_10939){ echo ' .coinType12274, .coinType12273 { border: 0 !important; } '; }
    echo '</style>';
    ?>
        ...
        <div class="row justify-content-center">
            <table class="platform-navigation">
                <tr>
                    ...
                    if($member_e && $first_segment!='@'.$member_e['e__id']){
