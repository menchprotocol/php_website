            ...
            <table class="mench-navigation">
                <tr>
                    ...
                    if ($user_e) {
                        ...
                        echo '<div class="mench_nav left_nav" style="padding: 10px 0 0;"><a href="'.home_url().'" class="montserrat '.extract_icon_color($user_e['e__icon']).'"><span class="icon-block">'.$user_e['e__icon'].'</span><span style="font-size: 1.3em;">'.$first_word.'<span class="show-max"> '.join(' ', $title_words).'</span></span></a></div>';
                    } else {
