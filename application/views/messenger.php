...
foreach ($this->Chains->read(array(
    ...
    if(count($this->Chains->read(array(
        ...
        'chainhandletype IN (' . join(',', array(42275 /* Hahstag Trigerred */ , 31022 /* Hahstag Skipped */)) . ')' => null, //Active Writes
    ...
    if (!$demo_only && (!$end_sending || $end_sending < time())) {
        ...
        //Ready to be done:
        $this->Chains->hashtag_discovered(($total_sent > 0 ? 42275 /* Hahstag Trigerred */ : 31022 /* Hahstag Skipped */), 26582, 0, $i);
