...
foreach($this->config->item('e___11089') as $x__type => $m) {
    ...
    if($ui){
        ...
        echo '<a class="headline" href="javascript:void(0);" onclick="toggle_headline('.$x__type.')"><span class="icon-block">'.$m['m__cover'].'</span>' . number_format($counter, 0) . ' '.$m['m__title'].'<span class="icon-block pull-right headline_title_'.$x__type.'"><i class="far fa-minus-circle"></i></span></a>';
