...
if(!$source_is_e || $superpower_13422){
    ...
    echo '<a class="headline" href="javascript:void(0);" onclick="toggle_headline(11030)"><span class="icon-block">'.$e___11035[11030]['m__cover'].'</span>' . number_format($counter, 0) . ' '.$e___11035[11030]['m__title'].' <i class="far fa-minus-circle headlineTitle headline_title_11030"></i></a>';
...
foreach($this->config->item('e___11089') as $x__type => $m) {
    ...
    if($ui){
        ...
        echo '<a class="headline" href="javascript:void(0);" onclick="toggle_headline('.$x__type.')"><span class="icon-block">'.$m['m__cover'].'</span>' . number_format($counter, 0) . ' '.$m['m__title'].' <i class="far fa-minus-circle headlineTitle headline_title_'.$x__type.'"></i></a>';
