...
echo '<div class="hideIfEmpty headline_body_11030" read-counter="'.$counter_top.'"><div class="tab_content"></div>'.( $write_access_e ? '<div class="new-list-11030"><div class="col-md-6 col-sm-8 col-10 container-center"><div class="dropdown_11030 list-adder">
...
foreach($this->config->item('e___41091') as $x__type => $m) {
    ...
    if($write_access_e){
        ...
        if($x__type==12273){
            ...
            //IDEAS
            $input_content .= '<div class="new-list-'.$x__type.'"><div class="col-md-6 col-sm-8 col-10 container-center"><div class="list-group"><div class="list-group-item dropdown_'.$x__type.' list-adder">
                <div class="input-group border">
                    <input type="text"
                           class="form-control form-control-thick algolia_search dotransparent add-input"
            ...
            $input_content .= '<div class="new-list-'.$x__type.'"><div class="col-md-6 col-sm-8 col-10 container-center"><div class="dropdown_'.$x__type.' list-adder">
                    <div class="input-group border">
                        <input type="text"
                               class="form-control form-control-thick algolia_search dotransparent add-input"
                               maxlength="' . view_memory(6404,6197) . '"
