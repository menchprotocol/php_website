...
foreach($this->config->item('e___11089') as $x__type => $m) {
    ...
    if(in_array($x__type, $this->config->item('n___6194'))){
        ...
        if($source_is_e){
            ...
            $ui .= '<div class="center" style="padding-top:144px;"><a class="btn btn-lrg btn-6255" href="/">'.$e___11035[18995]['m__cover'].' '.$e___11035[18995]['m__title'].' <i class="far fa-arrow-right"></i></a></div>';
        }
