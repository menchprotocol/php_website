...
foreach($e___14874 as $x__type => $m) {
    ...
    $nav_content .= '<li class="nav-item thepill'.$x__type.'"><a class="nav-link" active x__type="'.$x__type.'" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="'.number_format($counter, 0).' '.$m['m__title'].'" onclick="toggle_pills('.$x__type.')"><span class="icon-block-xxs">'.$m['m__cover'].'</span>'.( $x__type==12274 && $counter_top>0 ? '<span class="css__title hideIfEmpty xtypecounter'.$x__type.'">'.view_number($counter_top) . '</span>+' : '' ).'<span class="css__title hideIfEmpty xtypecounter'.$x__type_top.'" style="padding-right:4px;">'.view_number($counter) . '</span></a></li>';
