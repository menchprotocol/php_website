...
if($top_i__id) {
    ...
    if ($is_or_idea) {
        ...
        if(isset($_GET['process_pay']) && !count($x_completes)){
            ...
            echo 'You Do Not need to create a Paypal account: You can pay by only entering your credit card details & checkout as a guest. Once paid, click "Return to Merchant" to continue back here. By paying you agree to our <a href="/-14373" target="_blank"><u>Terms of Use</u></a>.';
