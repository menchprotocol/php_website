    ...
    if(count($find_previous)){
        ...
        foreach($find_previous as $followings_i){
            ...
            if(count($query_subset) >= 2){
                ...
                $breadcrum_content .= '<button type="button" class="btn no-side-padding" id="dropdownMenuButton'.$followings_i['i__id'].'" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
...
$body_prepend = '<a href="javascript:void(0);" onclick="editor_load_i(0,0,'.$focus_i['i__id'].')" style="margin-left: 0;">'.$e___11035[31772]['m__cover'].' '.$e___11035[31772]['m__title'].'</a></td>'; //TODO fix icon reference
$body_prepend = '';
