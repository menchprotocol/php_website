...
if($top_i__id || 1) {
    ...
    if ($is_or_idea) {
        ...
        foreach($this->X_model->fetch(array(
            ...
            //Print on screen:
            echo '<div><span class="icon-block-xss" title="'.$e___40787[$setting_link['x__type']]['m__title'].'">'.$e___40787[$setting_link['x__type']]['m__cover'].'</span><a href="/@' . $setting_link['e__id'] . '"><span class="icon-block-xss">'.view_cover($setting_link['e__cover'], true). '</span><u>' . $setting_link['e__title'] . '</u></a></div>';
        }
        ...
        foreach($this->X_model->fetch(array(
            ...
            //Print on screen:
            echo '<div><span class="icon-block-xss" title="'.$e___40787[$setting_link['x__type']]['m__title'].'">'.$e___40787[$setting_link['x__type']]['m__cover'].'</span><a href="/@' . $setting_link['i__id'] . '"><u>' . $setting_link['i__title'] . '</u></a></div>';
        }
