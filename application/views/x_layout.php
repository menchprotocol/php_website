...
echo '<h1 style="text-align: left; padding:0 21px;">'.( $has_cover && !$cover_image ? '<span class="icon-block-img">'.view_cover(12273,$i_focus['i__cover']).'</span> ' : '' ).$i_focus['i__title'].'</h1>';
