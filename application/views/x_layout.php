...
echo '<h1 class="msg-frame" style="text-align: left; padding: 10px 0 !important; font-size:2.5em;">'.( !$show_bg && strlen($i_focus['i__cover'])  ? '<span class="icon-block-img hideIfEmpty">'.view_cover(12273,$i_focus['i__cover']).'</span><br />' : '' ).$i_focus['i__title'].'</h1>';
