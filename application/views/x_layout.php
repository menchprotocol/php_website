...
foreach($this->X_model->fetch(array(
    ...
    echo '<div style="padding-top: 10px; padding-left: 41px; font-size:1.2em; font-weight: bold;">'. ( $x['e__id']==30976 /* Hack: Location loads with Google Maps */ ? '<a href="https://www.google.com/maps/search/'.urlencode($x['x__message']).'" target="_blank" style="text-decoration:underline; line-height:120%;">'.$x['x__message'].'</a>' : nl2br($x['x__message']) ) . '</div>';
    echo '</div>';
