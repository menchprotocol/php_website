...
foreach($this->X_model->fetch(array(
    ...
    echo '<span style=" ">'.$x['e__title'] . '</span>';
    echo '<div style="padding-top: 10px; padding-left: 41px; font-size:1.5em; font-weight: bold;">'. ( $x['e__id']==30976 /* Hack: Location loads with Google Maps */ ? '<a href="https://www.google.com/maps/search/'.urlencode($x['x__message']).'" target="_blank" style="text-decoration:underline;">'.$x['x__message'].'</a>' : $x['x__message'] ) . '</div>';
    echo '</div>';
