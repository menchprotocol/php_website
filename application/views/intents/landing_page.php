...
<div id="landing_page">
    ...
    <div class="price-box">
        ...
        <!-- Call to Action -->
        <a class="btn btn-primary" href="https://m.me/askmench?ref=SUBSCRIBE10_<?= $c['c_id'] ?>" style="display: inline-block; padding: 12px 30px;">Subscribe [Free] <i class="fas fa-angle-right"></i></a>
