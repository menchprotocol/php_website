...
function view_s_js(algolia_object){
    if(algolia_object.s__type==12274 || 1){
        //SOURCE
        return '<span class="icon-block">'+ ( algolia_object.s__type==12274 ? algolia_object.s__icon : '<i class="fas fa-plus-circle idea"></i>' ) +'</span><span class="montserrat">' + view_s__title(algolia_object) + '</span>';
    } else {
        //IDEA
