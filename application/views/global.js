...
function i_editor_load(i__id = 0, x__id = 0, link_x__type = 0, next_i__id = 0, previous_i__id = 0){
    ...
    if(next_i__id && js_n___4486.includes(link_x__type)){
        ...
        $("#modal31911 .idea_list_next").html($('.creator_frame_'+next_i__id).html().append('<p>hi</p>') + '<div class="idea_response">' + $('.ui_i__cache_'+next_i__id).html() + '</div>');
    } else if(previous_i__id && js_n___4486.includes(link_x__type)){
        i__id = 0;
        x__id = 0;
        $('#modal31911 .previous_i__id').val(previous_i__id);
        $("#modal31911 .idea_list_previous").html($('.creator_frame_'+previous_i__id).html().append('<p>hi</p>') + '<div class="idea_response">' + $('.ui_i__cache_'+previous_i__id).html() + '</div>');
    }
