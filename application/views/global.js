...
function i__add(x__type, link_i__id) {
    ...
    add_to_list("list-in-" + x__type, sort_handler, '<div id="tempLoader" class="col-12 col-sm-6 col-md-4 col-xl-2 col-lg-3 no-padding show_all_ideas"><div class="cover-wrapper"><div class="black-background-obs cover-link"><div class="cover-btn"><i class="far fa-yin-yang fa-spin"></i></div></div></div></div>');
