...
function view_s_js(algolia_object){
    ...
    if(algolia_object.s__type==12274 || 1){
        ...
        //IDEA
        //return '<div class="'+js_e___6404[13369]['m__message']+' no-padding"><div class="cover-wrapper"><div class="cover-link" style="background-image:url(\'' + algolia_object.s__icon + '\')"></div></div><div class="cover-content"><div class="inner-content css__title">'+view_s__title(algolia_object)+'</div></div></div>';
    }
}
...
function i_add(x__type, link_i__id, focus__id) {
    ...
    add_to_list(sort_list_id, sort_handler, '<div id="tempLoader" class="'+ js_e___6404[13369]['m__message'] +' no-padding show_all_ideas"><div class="cover-wrapper"><div class="black-background cover-link"><div class="cover-btn"><i class="far fa-yin-yang fa-spin idea"></i></div></div></div></div>', js_n___14686.includes(x__type));
