                    ...
                    header: function (data) {
                        if(validURL(data.query)){
                            ...
                            if(!isNaN(search_body)){
                                ...
                                return '<a href="' + ( $("#mench_search").val().charAt(0)=='#' ? '/!' : '/@' ) + search_body + '" class="suggestion"><span class="icon-block-sm"><i class="far fa-level-up rotate90" style="margin: 0 5px;"></i></span>Go to ' + data.query
                            }
