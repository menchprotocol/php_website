...
function activate_popover(){
    ...
    $('[data-toggle="popover"]').popover({
        ...
        content: function (inner_content) {
            ...
            return '<span class="icon-block"><i class="far fa-yin-yang fa-spin"></i></span>';
        }
    });
...
function i_editor_save(){
    ...
    i_saving = true;
    $(".i_editor_save").html('<span class="icon-block"><i class="far fa-yin-yang fa-spin"></i></span>');
    $("#modal31911 .save_results").html('');
...
function e_editor_save(){
    ...
    e_saving = true;
    $(".e_editor_save").html('<span class="icon-block"><i class="far fa-yin-yang fa-spin"></i></span>');
    $("#modal31912 .save_results").html('');
...
function e_select_apply(focus_id, selected_e__id, enable_mulitiselect, down_e__id, right_i__id){
    ...
    if((enable_mulitiselect || !field_required) && was_previously_selected){
        ...
        $('.radio-'+focus_id+' .item-'+selected_e__id+' .inner_headline').after('<span class="icon-block checked_icon" title="Selected" data-toggle="tooltip" data-placement="top"><i class="fas fa-check-circle"></i></span>');
    }
