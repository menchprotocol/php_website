...
function view_s_js(algolia_object){
    if(algolia_object.s__type==12274){
        ...
        //IDEA
        return '<div class="cover-wrapper pull-left"><div class="cover-link" style="background-image:url(\'' + algolia_object.s__icon + '\')"></div></div><div class="cover-content"><div class="inner-content">'+view_s__title(algolia_object)+'</div></div>';
    }
}
