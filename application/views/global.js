...
function view_s_js_line(suggestion){
    if(suggestion.s__type==12273){
        ...
        return '<span class="icon-block-xxs">'+ view_cover_js(suggestion.s__cover) +'</span><span class="grey">@' + suggestion.s__handle + '</span>&nbsp;<span class="main__title">' + view_s__title(suggestion) + '</span>';
    }
}
...
function editor_load_i(i__id, x__id, link_i__id = 0){
    ...
    if(link_i__id){
        ...
        $("#modal31911 .idea_reply").html('<div class="grey" style="padding-bottom:3px;">Reply To:</div>' + $('.creator_headline_frame_'+link_i__id).html() + '<div class="space-content">' + $('.ui_i__cache_'+link_i__id).html() + '</div>');
    ...
    $.post("/x/update_dropdown", {
        ...
        if (data.status) {
            ...
            if(element_id==6177){
                ...
                $('.s__12274_'+o__id+' .cover-link').removeClass('card_privacy_'+selected_e__id).addClass('card_privacy_'+new_e__id);
            }
