...
function editor_load_i(i__id = 0, x__id = 0, add_type = 0, next_i__id = 0, previous_i__id = 0){
    ...
    if(next_i__id && js_n___4486.includes(add_type)){
        ...
        $("#modal31911 .idea_reply").html('<div class="grey" style="padding:0 0 3px 0;"><span class="icon-block">'+js_e___4486[add_type]['m__cover']+'</span>'+js_e___4486[add_type]['m__title']+':</div>' + $('.creator_frame_'+next_i__id).html() + '<div class="space-content">' + $('.ui_i__cache_'+next_i__id).html() + '</div>');
