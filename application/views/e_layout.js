...
$(document).ready(function () {
    ...
    $('.en-type-counter-11030').text($('#list-in-11030 .source_cover').not(".hidden").length);
...
function e__add(x__type, e_existing_id) {
    ...
    $.post("/e/e__add", {
        ...
        if (data.status) {
            ...
            add_to_list(list_id, '.source_cover', data.e_new_echo, js_n___14686.includes(x__type));
...
function e_sort_save() {
    ...
    $("#list-in-11029 .source_cover").each(function () {
...
function e_sort_portfolio_load() {
    ...
    var sort = Sortable.create(theobject, {
        ...
        draggable: ".source_cover", // Specifies which items inside the element should be sortable
