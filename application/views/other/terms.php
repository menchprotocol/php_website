...
<ol type="a">
    <li>
        Permission is granted to temporarily download one copy of the materials (information or software) on Mench's
    ...
    <li>This license shall automatically terminate if you violate any of these restrictions and may be terminated by
        Mench at any time. Upon terminating your viewing of these materials or upon the termination of this license, you
...
<ol type="a">
    <li>The materials on Mench's website are provided on an 'as is' basis. Mench makes no warranties, expressed or
    ...
    <li>Further, Mench does not warrant or make any representations concerning the accuracy, likely results, or
...
<p>In no event shall Mench or its suppliers be liable for any damages (including, without limitation, damages for loss
    of data or profit, or due to business interruption) arising out of the use or inability to use the materials on
    Mench's website, even if Mench or a Mench authorized representative has been notified orally or in writing of the
...
<p>The materials appearing on Mench's website could include technical, typographical, or photographic errors. Mench does
    not warrant that any of the materials on its website are accurate, complete or current. Mench may make changes to
    the materials contained on its website at any time without notice. However Mench does not make any commitment to
    update the materials.</p>
<br/>
<h3>6. Links</h3>

<p>Mench has not reviewed all of the sites linked to its website and is not responsible for the contents of any such
    linked site. The inclusion of any link does not imply endorsement by Mench of the site. Use of any such linked
    website is at the user's own risk.</p>
<br/>
<h3>7. Modifications</h3>

<p>Mench may revise these terms of service for its website at any time without notice. By using this website you are
    agreeing to be bound by the then current version of these terms of service.</p>
<br/>
<h3>8. Governing Law</h3>

<p>These terms and conditions are governed by and construed in accordance with the laws of British Columbia, Canada and
...
<p>It is Mench's policy to respect your privacy regarding any information we may collect while operating our website.
    Accordingly, we have developed this privacy policy in order for you to understand how we collect, use, communicate,
    disclose and otherwise make use of personal information. We have outlined our privacy policy below.</p>
...
<ul>
    ...
    <li>We will collect and use personal information solely for fulfilling those purposes specified by us and for other
...
<p>We are committed to conducting our business in accordance with these principles in order to ensure that the
    confidentiality of personal information is protected and maintained. Mench may change this privacy policy from time
    to time at Mench's sole discretion.</p>