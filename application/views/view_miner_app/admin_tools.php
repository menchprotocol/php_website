...
if(!$action) {
    ...
    foreach ($this->Intents_model->in_fetch(array(
        ...
        foreach($this->Links_model->ln_fetch(array(
            ...
            $qualified_update = ( $child_or['in_type_entity_id']==6677 /* AND GOT IT */ && in_array($child_or['in_visibility_entity_id'], $this->config->item('en_ids_7582')) /* Intent Action Plan Addable */ );
