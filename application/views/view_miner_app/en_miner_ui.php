                    ...
                    <div class="col-md-6">
                        ...
                        <div class="inline-box" style="margin-bottom: 15px;">
                            ...
                            <span class="mini-header">Entity Icon:
                                ...
                                <a href="javascript:void(0);" style="margin-left: 5px;" onclick="$('#en_icon').val($('#en_icon').val() + '<i class=&quot;far fa-&quot;></i>' )" data-toggle="tooltip" title="Insert blank Font-Awesome HTML code" data-placement="top"><i class="fas fa-plus-circle"></i><b>FA</b></a>
