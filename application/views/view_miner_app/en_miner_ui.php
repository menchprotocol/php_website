    ...
    <div class="<?= $this->config->item('css_column_1') ?>">
        ...
        echo '<form class="mass_modify indent2 hidden" method="POST" action="" style="width: 100% !important;"><div class="inline-box">';
            ...
            foreach ($this->config->item('en_all_4997') as $action_en_id => $mass_action_en) {
                ...
                $input_options .= '<i class="far fa-info-circle" data-toggle="tooltip" data-placement="right" title="'.$mass_action_en['m_desc'].'"></i> ';
                    ...
                    <div class="col-xs-6">
                        ...
                        <div class="inline-box" style="margin-bottom: 15px;">
                            ...
                            <span class="mini-header"><?= $en_all_6206[6198]['m_icon'].' '.$en_all_6206[6198]['m_name'] ?>
                                ...
                                <i class="far fa-info-circle" data-toggle="tooltip" title="<?= is_valid_icon(null, true) ?> Click to see Font-Awesome Icons in a new window." data-placement="right"></i>
