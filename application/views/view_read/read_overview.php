...
<div class="container">
    ...
    <div class="alert alert-info" style="margin-bottom: 20px;">
        <div><i class="fas fa-lightbulb-on"></i> <b class="montserrat">MENCH</b> is an interactive publishing platform that allows anyone to share ideas that matter. Writers use a simple web app to create microblogs, each focused on a key idea. Microblogs link together to communicate bigger ideas, or cite expert sources to gain credibility. Readers use the web or Messenger to interactively read & discover top ideas. Players earn crypto-coins for each word they <i class="fas fa-circle ispink"></i> <b class="montserrat ispink">READ</b> or <i class="fas fa-circle yellow"></i> <b class="montserrat yellow">BLOG</b>.</div>
