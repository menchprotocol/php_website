...
<div class="container">
    ...
    <div class="alert alert-info">
        ...
        <div style="margin-top:10px;">
            ...
            <span class="top-players inline-block" style="padding: 0 0 12px 0;"><i class="fas fa-medal"></i> <a href="javascript:void(0);" onclick="load_leaderboard()" class="montserrat">SEE TOP PLAYERS</a></span>
        </div>
    </div>
