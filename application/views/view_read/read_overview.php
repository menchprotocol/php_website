...
<div class="container">
    ...
    <div class="top-players"><span class="icon-block"><i class="fas fa-medal"></i></span><a href="javascript:void(0);" onclick="load_leaderboard()" class="montserrat">TOP PLAYERS</a></div>
