...
<div class="container">
    ...
    <div class="animate-trigger" style="padding-top:20px;"><a href="javascript:void(0);" onclick="stream();" class="btn btn-lg btn-play montserrat"><i class="fas fa-play-circle"></i> WATCH 1 MIN INTRO</a> <a href="javascript:void(0);" onclick="stream();" class="btn btn-lg btn-play montserrat"><i class="fas fa-play-circle"></i> WATCH 1 MIN INTRO</a></div>
