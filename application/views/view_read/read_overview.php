...
<div class="container">
    ...
    <div class="alert alert-info">
        ...
        <div style="margin-top:10px;"><span class="inline-block" style="margin: 0 12px 12px 0;"><i class="fas fa-pen-square"></i> <a href="/blog" class="montserrat">START WRITING</a></span><span class="top-players inline-block" style="margin: 0 0 12px 0;"><i class="fas fa-medal"></i> <a href="javascript:void(0);" onclick="load_leaderboard()" class="montserrat">LEADERBOARD</a></span></div>
    </div>
