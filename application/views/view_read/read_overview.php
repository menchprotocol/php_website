...
<div class="container">
    ...
    <div class="alert alert-info">
        ...
        <div style="margin-top:10px;"><i class="fas fa-pen-square"></i> <a href="/blog" class="montserrat">START WRITING</a> &nbsp; <span class="top-players inline-block"><i class="fas fa-medal"></i> <a href="javascript:void(0);" onclick="load_leaderboard()" class="montserrat">LEADERBOARD</a></span></div>
    </div>
