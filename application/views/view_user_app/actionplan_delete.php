...
echo '<p  style="margin-top:20px;"><a href="/user_app/actionplan_reset_progress/'.$session_en['en_id'].'/'.$timestamp.'/'.md5($session_en['en_id'] . $this->config->item('cred_password_salt') . $timestamp).'" class="btn btn-primary" style="background-color: #FF0000; color: #FFF;"><i class="fas fa-trash-alt"></i> Clear Action Plan</a> or <a href="/actionplan" class="btn btn-primary grey"><i class="fas fa-undo-alt"></i> Cancel & Go Back</a></p>';
