...
echo '<div class="row">';
    echo '<div class="col-md-7">';
        ...
        echo '<div style="margin: -10px 0 6px 36px; color:#999;">';
            echo ' &nbsp;<span data-toggle="tooltip" data-placement="top" title="Ledger transaction ID" style="min-width:80px; display: inline-block;"><i class="fal fa-coins"></i> '.number_format($trs_count[0]['coins_sum'], 0).' Coins Awarded</span>';
        echo '</div>';
