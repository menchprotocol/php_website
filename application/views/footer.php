                ...
                <div class="modal-body block_search_results">
                    ...
                    <table style="width: 100%; margin-bottom: 34px;">
                        <tr>
                            <td style="width: 100%;">
                                <!-- SEARCH -->
                                <input id="search_cover" type="text" class="form-control text-edit border-dotted cover_query algolia_search" placeholder="Search or Paste Image URL..." data-lpignore="true" />
