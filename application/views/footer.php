        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    //URL
                    echo '<div class="headline"><span class="icon-block">'.$e___14393[10876]['m__icon'].'</span>'.$e___14393[10876]['m__title'].'</div>';
                    echo '<div class="padded"><a href="javascript:void(0);" onclick="copy_share_this_url();" id="share_this_url" class="inline-block"><span></span>&nbsp;&nbsp;<i class="fa fa-gif-wrap">COPY</i></a></div>';
