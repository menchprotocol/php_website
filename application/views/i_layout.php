...
echo '<td width="21%" style="text-align: left;" class="'.superpower_active(12700).'">'.$e___11035[4356]['m__icon'].'<div class="inline-block left-half-margin">'.view_input_text(4356, $i_focus['i__duration'], $i_focus['i__id'], $e_of_i && $is_active, 0).'</div></td>';
