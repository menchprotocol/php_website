...
echo '<td style="text-align: left; padding-right: 5px;"><a href="javascript:void(0);" class="css__title" onclick="$(\'#modal14819\').modal(\'show\');"><span class="icon-block">'.$e___11035[14819]['m__icon'].'</span><span class="">'.$e___11035[14819]['m__title'].'</span></a></td>';
echo '</tr>';
