...
if($write_privacy_i && count($this->X_model->fetch(array(
    ...
    echo '<div class="alert alert-default" role="alert"><span class="icon-block-sm">'.$e___11035[30795]['m__cover'].'</span>You can discover this idea in <a href="/'.$focus_i['i__hashtag'].'/start"><b><u>'.$e___11035[30795]['m__title'].'</u></b></a></div>';
}
