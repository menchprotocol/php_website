...
echo '<td style="text-align: right;"><a href="javascript:void(0);" class="css__title" onclick="$(\'#modal14819\').modal(\'show\');">'.$e___11035[14819]['m__title'].'<span class="icon-block">'.$e___11035[14819]['m__icon'].'</span></a></td>';
echo '</tr>';
