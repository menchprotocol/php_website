                    ...
                    <div>
                        ...
                        <div class="inline-box">
                            ...
                            <form class="drag-box" method="post" enctype="multipart/form-data">
                                ...
                                <span><input class="box__file inputfile" type="file" name="file" id="file" /><label class="" for="file" data-toggle="tooltip" title="Upload files up to <?= config_var(11063) ?> MB" data-placement="top"><i class="fal fa-cloud-upload"></i> Upload</label></span>
                            </form>
