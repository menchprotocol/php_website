        ...
        foreach ($this->config->item('en_all_'.$en_id) as $en_id2 => $m2){
            ...
            if($en_id2==11030){
                ...
                $this_tab .= '<div id="new-parent" class="'.require_superpower(10983).'">
                    ...
                    <div class="algolia_search_pad hidden"><span class="icon-block"><i class="fas fa-search-plus blue"></i></span><b class="montserrat">Search players, create a new player or paste a URL...</b></div>
            </div>';
