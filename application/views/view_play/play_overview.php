    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            foreach($this->config->item('en_all_2738') as $en_id => $m){
                ...
                echo '<p class="inline"> '.$m['m_desc'].' <span class="inline-block"><a href="'.$navigation[$en_id].'" class="montserrat color'.$en_id.'">'.$m['m_name'].'</a> <i class="fas fa-arrow-right color'.$en_id.'"></i></span></p>';
                echo '<br />';
            }
            ?>
        </div>
