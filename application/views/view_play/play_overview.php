    ...
    <div class="row">
        ...
        if($this->uri->segment(1) != 'play'){
            ...
            foreach($this->config->item('en_all_2738') as $en_id => $m){
                ...
                echo '<td valign="bottom" style="width: 33%"><span class="'.$handle.' border-'.$handle.'">' . $m['m_icon'] . ' <span class="montserrat current_count"><i class="far fa-yin-yang fa-spin"></i></span><div class="montserrat">' . $m['m_desc'] . '</div></span></td>';
            }
