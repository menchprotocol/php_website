...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <h1>HOW TO PLAY</h1>
            <ul class="none-list">
                <li><b class="montserrat play"><?= $en_all_2738[4536]['m_icon'] .' '. $en_all_2738[4536]['m_name'] ?></b> coin earned once when you first join</li>
                ...
                <li><b class="montserrat read"><?= $en_all_2738[6205]['m_icon'] .' '. $en_all_2738[6205]['m_name'] ?></b> up to <?= number_format(config_var(11061), 0) ?> words/month always free</li>
                ...
                <li><b class="montserrat blog"><?= $en_all_2738[4535]['m_icon'] .' '. $en_all_2738[4535]['m_name'] ?></b> coins could earn you monthly cash</li>
            </ul>
        </div>
