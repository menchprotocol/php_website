    ...
    <div class="row">
        <div class="col-lg">
            ...
            <ul class="intructions-list double-line-list">
                ...
                <li>A non-profit/open-source organization on a mission to build and share consensus</li>
                <li>A community of thinkers and doers who share stories/ideas that matter</li>
            </ul>
