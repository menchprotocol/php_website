...
<div class="container">
    <div class="row">
        ...
        <div class="learn_more hidden">
            <h1>HOW TO PLAY</h1>
            <ul class="none-list">
                <li><b class="montserrat play"><?= $en_all_2738[4536]['m_icon'] .' '. $en_all_2738[4536]['m_name'] ?></b> awarded for each new player</li>
                <li><b class="montserrat read"><?= $en_all_2738[6205]['m_icon'] .' '. $en_all_2738[6205]['m_name'] ?></b> awarded for each word read</li>
                ...
                <li><b class="montserrat blog"><?= $en_all_2738[4535]['m_icon'] .' '. $en_all_2738[4535]['m_name'] ?></b> awards cash <b class="montserrat">income/month</b></li>
            </ul>
        </div>
