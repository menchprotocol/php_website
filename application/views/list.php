...
echo '<div class="center-frame hide-subline maxwidth hideIfEmpty remove_first_line">' . view_post_value($post_settings['i'], ( isset($user_session['userid']) ? $user_session['userid'] : 0 )) . '</div>';
