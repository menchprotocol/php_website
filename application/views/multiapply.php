...
if ($_GET['focus__id']==12273 && superpower_unlocked(12700) && isset($_POST['s__id']) && isset($_POST['mass_action_toggle']) && isset($_POST['mass_value1_'.$_POST['mass_action_toggle']]) && isset($_POST['mass_value2_'.$_POST['mass_action_toggle']])) {
    ...
    //Process mass action:
    $process_mass_action = $this->Idea_cache->mass_update($_POST['s__id'], intval($_POST['mass_action_toggle']), $_POST['mass_value1_'.$_POST['mass_action_toggle']], $_POST['mass_value2_'.$_POST['mass_action_toggle']], $player_e['playerid']);
    ...
    foreach($this->Idea_cache->fetch(array('ideaid' => $_POST['s__id'])) as $i){
    ...
    //Process mass action:
    $process_mass_action = $this->Source_cache->mass_update($_POST['s__id'], intval($_POST['mass_action_toggle']), $_POST['mass_value1_'.$_POST['mass_action_toggle']], $_POST['mass_value2_'.$_POST['mass_action_toggle']], $player_e['playerid']);
    ...
    foreach($this->Source_cache->fetch(array('playerid' => $_POST['s__id'])) as $e){
