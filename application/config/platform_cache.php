...
//Generated 2019-11-28 14:25:32 PST

//BLOG NOTE ADD PLAYER:
$config['en_ids_12019'] = array(12020,12021,12022);
$config['en_all_12019'] = array(
    12020 => array(
        'm_icon' => '<i class="fas blue fa-fingerprint" aria-hidden="true"></i>',
        'm_name' => 'FIRST NAME',
        'm_desc' => '',
        'm_parents' => array(12019),
    ),
    12021 => array(
        'm_icon' => '<i class="fas blue fa-paperclip"></i>',
        'm_name' => 'UPLOAD FILE',
        'm_desc' => '',
        'm_parents' => array(12019),
    ),
    12022 => array(
        'm_icon' => '<i class="fas blue fa-at"></i>',
        'm_name' => 'REFERENCE PLAYER',
        'm_desc' => '',
        'm_parents' => array(12019),
    ),
);

//BLOG NOTE CONTROL PANEL:
$config['en_ids_12017'] = array(12014,12015,12018,12019);
$config['en_all_12017'] = array(
    12014 => array(
        'm_icon' => '<i class="fas fa-check-square"></i>',
        'm_name' => 'SAVE BUTTON',
        'm_desc' => '',
        'm_parents' => array(12017),
    ),
    12015 => array(
        'm_icon' => '<i class="fas fa-comment-alt-exclamation"></i>',
        'm_name' => 'SAVE RESPONSE',
        'm_desc' => '',
        'm_parents' => array(12017),
    ),
    12018 => array(
        'm_icon' => '<i class="fas fa-tally"></i>',
        'm_name' => 'TEXTAREA COUNT',
        'm_desc' => '',
        'm_parents' => array(12017),
    ),
    12019 => array(
        ...
        'm_name' => 'ADD PLAYER',
        'm_desc' => '',
        'm_parents' => array(11040,4527,12017),
    ),
);
...
$config['en_all_11089'] = array(
    ...
    7545 => array(
        ...
        'm_desc' => '',
        'm_parents' => array(11089,10967,10990,10594,10589,7703,7551,4593,4485),
    ),
    4997 => array(
...
$config['en_all_11007'] = array(
    ...
    11011 => array(
        ...
        'm_name' => 'MONTHLY SUBSCRIPTION',
        'm_desc' => 'Read Unlimited for $5/Month',
        'm_parents' => array(11162,11007),
    ),
    11012 => array(
        'm_icon' => '<i class="fas fa-usd-circle yellow" aria-hidden="true"></i>',
        'm_name' => 'YEARLY SUBSCRIPTION',
        'm_desc' => 'Read Unlimited for $50/Year',
...
$config['en_all_2738'] = array(
    ...
    4535 => array(
        ...
        'm_name' => 'BLOG',
        'm_desc' => 'ideas collaboratively by saving, organizing and publishing them on MENCH. Earn 1x BLOG COIN for each word you blog and earn monthly revenues.',
        'm_parents' => array(2738,4463),
    ),
);
...
//PLATFORM MEMORY:
$config['en_ids_4527'] = array(7758,10809,10956,11047,7712,4983,7756,7585,10602,10589,11968,10990,12019,12017,4485,12012,7347,6146,7596,7588,4229,11018,4486,7302,4737,7356,7355,6201,11021,7309,7751,6150,10712,10719,10869,10627,10746,7703,7364,10717,10721,10720,11080,2738,7555,11035,11059,11058,10716,6225,10718,10711,11054,6404,4527,6232,11039,6194,6827,4426,4997,4454,11028,4592,4537,6123,6177,11007,11089,11033,3000,7303,6206,11088,4755,6287,10571,7357,6345,6192,11081,6193,4600,5967,6255,4280,10590,10570,4277,6102,7704,6244,6274,7494,6144,7582,6103,10596,10539,10594,10692,10591,10593,7304,6186,7360,7359,4341,4593,10658,10592,11031,11084,6204,10710,10957,10725,6805,4986,7551,7358);
$config['en_all_4527'] = array(
    ...
    12019 => array(
        'm_icon' => '<i class="fas fa-caret-down" aria-hidden="true"></i>',
        'm_name' => 'BLOG NOTE ADD PLAYER',
        'm_desc' => '',
        'm_parents' => array(11040,4527,12017),
    ),
    12017 => array(
        'm_icon' => '<i class="fas fa-ellipsis-h" aria-hidden="true"></i>',
        'm_name' => 'BLOG NOTE CONTROL PANEL',
        'm_desc' => '',
        'm_parents' => array(4527,12013),
    ),
    4485 => array(
...
//BLOG AUTHORS:
$config['en_ids_4983'] = array(2997,4446,12013,3005,3147,3084,4763,4430,2999,4883,3192,5948,2998);
$config['en_all_4983'] = array(
    ...
    12013 => array(
        ...
        'm_name' => 'BLOG NOTE PAD',
        'm_desc' => '',
        'm_parents' => array(7545,4983,4601,4231),
    ),
    3005 => array(
        'm_icon' => '<i class="far fa-book" aria-hidden="true"></i>',
        'm_name' => 'BOOKS',
