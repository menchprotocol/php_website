...
$config['base_url']                 = 'https://'.get_domain('m__message');
...
| something else. If you are using mod_rewrite to delete the page set this
...
| If your transactions do not seem to work, try one of the other delicious flavors:
|
...
|
*/
$config['error_views_path'] = 'application/views/error/';
