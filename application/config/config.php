...
//App Functionality:
$config['app_version']              = '0.931'; //Cache buster for static JS/CSS files, so needs to be updated if you update static files
...
$config['in_system_lock']           = array(8469, 7766, 11762); //Once set to published, their status will be locked by system
