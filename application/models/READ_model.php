            ...
            if(!count($in__children)){
                ...
                if(count($previously_answered) > 0 && !$push_message){
                    ...
                    echo '<div class="selected_before">';
                        ...
                        //Allow to edit:
                        echo ' <a href="javascript:void(0);" onclick="$(\'.selected_before\').toggleClass(\'hidden\');"><span class="icon-block"><i class="far fa-pen-square"></i></span><b class="montserrat">EDIT ANSWER</b></a>';
                ...
                if ($push_message) {
                    ...
                    echo '<div style="padding:20px 0;"><a class="btn btn-read" href="javascript:void(0)" onclick="read_save_answer()">'.( count($previously_answered)>0 ? 'UPDATE' : 'SAVE' ).' & CONTINUE <i class="fas fa-angle-right"></i></a> <span class="result-update"></span></div>';
