        ...
        if (count($string_references['ref_players']) > 0) {
            ...
            if (!$push_message) {
                ...
                if($is_user_message){
                    ...
                    $player_name_replacement = ( $has_text ? '<span class="icon-block icon_photo">'.echo_en_icon($ens[0]['en_icon']).'</span><span class="player-name '.extract_icon_color($ens[0]['en_icon']).'">'.$ens[0]['en_name'].'</span>' : '' );
