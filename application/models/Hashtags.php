...
class Hashtags extends CIdea_cache
{
    ...
    function create($add_fields, $chainhandlecreator = 14068 /* GUEST */)
    {
        ...
        $add_fields['hashtaghtmlread'] = hashtaghtmlread($add_fields['hashtagid'], $add_fields['hashtagvalue']);
    ...
    function update($chainid, $update_columns, $chainhandlecreator = 0)
    {
        ...
        foreach ($hashtags_found as $hashtag_current) {
            ...
            $skip_sync_ledger = array('hashtaghtmlread', 'hashtagexternal', 'hashtagkey', 'hashtagtype');
            ...
            if (isset($update_columns['hashtagvalue']) && !isset($update_columns['hashtaghtmlread'])) {
                //Update Hashtag Text:
                $update_columns['hashtaghtmlread'] = hashtaghtmlread($chainid, $update_columns['hashtagvalue']);
            }
