        ...
        foreach($string_references['ref_e'] as $referenced_e){
            ...
            if(!$is_current_e || $string_references['ref_time_found']){
                ...
                foreach($this->X_model->fetch(array(
                    ...
                    //if(!strlen($e_up['x__message']) || (in_array($e_up['e__access'], $this->config->item('n___30956')) && !e_of_e($e_up['e__id']))){ continue; }
            ...
            if($on_its_own_line){
                ...
                $output_body_message = str_replace($identifier_string, ( !count($e_links) || !$is_discovery_mode ? $edit_btn : '' ).$e_dropdown, $output_body_message).$e_appendix;
            }
