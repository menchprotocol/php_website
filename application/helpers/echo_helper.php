...
function echo_in_recommend($in, $common_prefix = null, $hide_class = null, $referrer_en_id = 0)
{
    ...
    $CI =& get_instance();
    $session_en = en_auth();
    $is_starting = ( in_array($in['in_visibility_level_entity_id'], $CI->config->item('en_ids_7582')) /* Intent Action Plan Addable */);
...
function echo_in($in, $level, $in_linked_id = 0, $is_parent = false)
{
    ...
    $ui .= '<span class="icon-top-left '.advance_mode().' in_visibility_level_entity_id_' . $in['in_id'] . '" data-toggle="tooltip" data-placement="right" title="'.$en_all_7596[$in['in_visibility_level_entity_id']]['m_name'].': '.$en_all_7596[$in['in_visibility_level_entity_id']]['m_desc'].'">' . $en_all_7596[$in['in_visibility_level_entity_id']]['m_icon'] . '</span>';
