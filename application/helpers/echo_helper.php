...
function echo_in_dropdown($cache_en_id, $selected_en_id, $btn_class, $is_source, $show_full_name, $in_id = 0, $ln_id = 0){
    ...
    $ui = '<div class="dropdown inline-block dropd_'.$cache_en_id.'_'.$in_id.'_'.$ln_id.' '.( !$show_full_name ? ' icon-block ' : '' ).'" selected-val="'.$selected_en_id.'" title="'.$en_all_12079[$cache_en_id]['m_name'].'" data-toggle="tooltip" data-placement="top">';
