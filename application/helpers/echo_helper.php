...
function echo_mench_stats(){
    ...
    $ui .= '</tr>';
    $ui .= '<tr>';
    $ui .= '<td class="play MENCHcolumn1"><span class="icon-block show-max">&nbsp;</span><span class="montserrat" style="padding-left: 8px;">PLAYERS</span></td>';
    $ui .= '<td class="idea MENCHcolumn2"><span class="icon-block show-max">&nbsp;</span><span class="montserrat" style="padding-left: 8px;">IDEAS</span></td>';
    $ui .= '<td class="read MENCHcolumn3"><span class="icon-block show-max">&nbsp;</span><span class="montserrat" style="padding-left: 8px;">READS</span></td>';
    $ui .= '</tr>';
    $ui .= '</table>';
