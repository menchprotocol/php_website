...
function echo_en($en, $is_parent = false)
{
    ...
    //SOURCE NAME
    $ui .= '<a href="/source/'.$en['en_id'] . '" class="title-block title-no-right montserrat '.extract_icon_color($en['en_icon']).'">'.($child_links[0]['totals'] > 0 ? '<span class="'.superpower_active(10983).'">'.echo_number($child_links[0]['totals']).'&nbsp;</span>' : '').'<span class="en_name_full_' . $en['en_id'] . '">'.$en['en_name'].'</span></a>';
