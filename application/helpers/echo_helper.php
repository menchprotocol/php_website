...
function echo_en_messages($ln){
    ...
    $ui .= '<li><a class="btn btn-primary" style="border:2px solid #f9da22 !important;" href="/links?ln_id=' . $ln['ln_id'] . '" target="_parent"><i class="fas fa-link"></i> '.echo_number($count_msg_trs[0]['totals']).'</a></li>';
...
function echo_in($in, $level, $in_linked_id = 0, $is_parent = false)
{
    ...
    if ($level == 0) {
        ...
        $ui .= '&nbsp;<a href="/intents/' . $in['in_id'] . '" class="badge badge-primary is_not_bg is_hard_link" style="display:inline-block; margin-right:-2px; width:40px; border:2px solid #f9da22 !important;">'.$tree_count.'<i class="fas fa-angle-right"></i></a>';
