...
function echo_en_coins($coin_count = 0){
    ...
    return ( $coin_count > 0 ? '<span class="inline-block pull-right '.superpower_active(10983).'"><span class="montserrat" title="'.number_format($coin_count, 0).'">'.echo_number($coin_count).'</span>' : '<span class="inline-block pull-right"><span class="montserrat current_count"><i class="far fa-yin-yang fa-spin"></i></span>' ).'<span class="parent-icon icon-block">' . $en_all_2738[4536]['m_icon'] . '</span></span>';
}
