...
function echo_in_dropdown($cache_en_id, $selected_en_id, $btn_class, $is_author, $ln_id = 0){
    ...
    foreach ($en_all_this as $en_id => $m) {
        ...
        if($cache_en_id==7585){
            ...
            if($en_id==6677){
                $ui .= '<h6 class="dropdown-header"><span data-toggle="tooltip" data-placement="right" title="'.$en_all_10602[6192]['m_desc'].'">'.$en_all_10602[6192]['m_name'].' <i class="fal fa-info-circle"></i></span></h6>';
            } elseif($en_id==6684){
                $ui .= '<h6 class="dropdown-header"><span data-toggle="tooltip" data-placement="right" title="'.$en_all_10602[6193]['m_desc'].'">'.$en_all_10602[6193]['m_name'].' <i class="fal fa-info-circle"></i></span></h6>';
            }
        }
