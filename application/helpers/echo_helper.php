...
function echo_in_previous_discover($in_id, $recipient_en){
    ...
    if($previous_level_id > 0){
        ...
        //Main Discovery:
        if($top_completion_rate){
            $ui .= '<div class="container fixed-bottom montserrat" title="You are '.$top_completion_rate['completion_percentage'].'% done as you have discover '.$top_completion_rate['steps_completed'].' of '.$top_completion_rate['steps_total'].' ideas" data-toggle="tooltip" data-placement="top"><div class="progress-bg-big"><div class="progress-done" style="width:'.$top_completion_rate['completion_percentage'].'%"></div><a href="/'.$top_completion_rate['top_in']['in_id'].'">'.$top_completion_rate['top_in']['in_title'].'</a></div></div>';
        }
    }
