...
function echo_in_note_mix($note_type_en_id, $in_notes, $is_source){
    ...
    //YouTube Clip
    $ui .= '<td style="width:42px; padding: 10px 0 0 0;"><a href="javascript:in_notes_insert_string('.$note_type_en_id.', \'https://www.youtube.com/embed/VIDEO_ID_HERE?start=SECOND_HERE&end=SECOND_HERE\');" data-toggle="tooltip" title="YOUTUBE CLIP: A URL format to slice a video using a start & end time (IN SECONDS)" data-placement="top"><span class="icon-block"><i class="fab fa-youtube"></i></span></a></td>';
