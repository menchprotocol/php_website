...
function echo_en($en, $is_parent = false, $extra_class = null, $control_enabled = false, $is_source = false)
{
    ...
    $ui .= '<span class="icon-block en_ui_icon_' . $en['en_id'] . ' en__icon_'.$en['en_id'].'" en-is-set="'.( strlen($en['en_icon']) > 0 ? 1 : 0 ).'">' . echo_en_icon($en['en_icon']) . '</span>';
        ...
        if(superpower_active(12701, true)){
            ...
            $ui .= '<span class="'.superpower_active(12701).'"><span class="icon-block dorubik black" title="'.number_format($en__portfolios_count[0]['totals'], 0).'">'.echo_number($en__portfolios_count[0]['totals']).'</span></span>';
        }
