    ...
    if(count($in__children)){
        ...
        if($push_message){
            ...
            if($found_upcoming > 0 && !$all_done){
                echo '<div class="is_upcoming montserrat side-margin" style="padding:5px 0;"><a href="javascript:void(0);" onclick="$(\'.is_upcoming\').toggleClass(\'hidden\');"><span class="icon-block"><i class="far fa-plus-circle"></i></span>'.$found_upcoming.' MORE</a></div>';
            }
        }
