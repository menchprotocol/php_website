...
function echo_en_load_more($page, $limit, $en__child_count)
{
    ...
    //$ui .= '<span class="icon-block"><i class="far fa-search-plus blue"></i></span>LOAD ' . (($page * $limit) + 1) . ' - ' . $max_players . ' OF ' . $en__child_count; //May not be accurate due to HIDDEN PLAYERS that are not displayed publicly...
    $ui .= '<span class="icon-block"><i class="far fa-search-plus blue"></i></span>LOAD MORE';
    $ui .= '</a></div>';
