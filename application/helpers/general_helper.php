...
function link_view($x)
{
    ...
    foreach ($CI->config->item('players___4341') as $playerid => $m) {
        ...
        if (in_array(6160, $m['m__following'])) {
            ...
            //SOURCE
            $column_value .= '<td '.( $playerid==4593 ? 'rowspan="2"' : '' ).' style="width:25px !important; vertical-align : middle;"><div style="width:25px !important; overflow:hidden;">';
            ...
            //Void:
            $column_value .= '<td rowspan="2" style="width:60px !important; vertical-align : middle;">';
