...
function user_view($chainusertype, $e, $extra_class = null, $extra_value = null)
{
    ...
    foreach ($CI->Chains->read(array(
        ...
        $info = str_replace('"','',str_replace('\'','',htmlentities(strlen($social_chain['chainvalue']) && !$social_url ? $users___14036[$social_chain['chainuserinput']]['m__name'] . ': ' . $social_chain['chainvalue'] : ($social_url ? view_url_clean(one_two_explode('href="', '"', $social_url)) : $users___14036[$social_chain['chainuserinput']]['m__name']))));
