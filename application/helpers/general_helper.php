    ...
    foreach($fetch_objects as $loop_obj){
        ...
        foreach ($db_rows[$loop_obj] as $db_row) {
            ...
            if ($loop_obj == 'en') {
                ...
                $export_row['alg_in_visibility_level_entity_id'] = intval($db_row['in_visibility_level_entity_id']);
...
function fetch_credits($ln_type_entity_id){

    //Credits for each Link Type:
    $CI =& get_instance();
    $en_all_4595 = $CI->config->item('en_all_4595');

    //Does this link type award credits?
