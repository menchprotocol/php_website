                    ...
                    foreach(array('x__up','x__down') as $e_ref_field){
                        if($fetched_source[$e_ref_field] > 0){
                            ...
                            foreach($CI->DISCOVER_model->fetch(array(
                                ...
                                //LINK
                                $ui .= '<a href="'.$e_profile['x__message'].'" target="_blank" class="dropdown-item montserrat doupper '.extract_icon_color($e_profile['e__icon']).'"><span class="icon-block">'.$e_profile['e__icon'].'</span>'.$e_profile['e__title'].' asdasdasd</a>';
