...
function view_progress($completion_rate, $i, $extra_class = null){
    return '<div class="progress-bg-list '.$extra_class.'"><div class="progress-done" style="width:'.$completion_rate['completion_percentage'].'%"></div><div class="progress-rate"><span class="icon-block">'.view_icon_i_x($completion_rate['completion_percentage'], $i, 13752 /* NOT STARTED */ ).'</span>'.$completion_rate['completion_percentage'].'% COMPLETE<span class="show-max">: '.$completion_rate['steps_completed'].'/'.$completion_rate['steps_total'].' IDEAS</span></div></div>';
}
