    ...
    if(in_array($x__type, $CI->config->item('n___14311'))){
        ...
        foreach($CI->config->item('e___14418') as $x__type => $m) {
            ...
            if($x__type==14419){
                ...
                $focus_tab .= '<textarea class="form-control msg note-textarea algolia_search new-note emoji-input input_note_'.$x__type.'" note_type_id="' . $x__type . '" placeholder="WRITE..." i__id="'.$i['i__id'].'" x__type="'.$x__type.'" old-value="'.$textarea_content.'" style="margin:13px 0 0 41px; width:calc(100% - 41px);">'.$textarea_content.'</textarea>';
