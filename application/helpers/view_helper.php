...
function view_i_select($i, $x__source, $previously_selected){
    ...
    if($view_i_time){
        $ui .= '<div class="cover-text"><a '.$href.' class="doblock"><span class="light-bg coin-hover">' . $view_i_time . '</span></a></div>';
    }
    $ui .= '</div></div>';
    $ui .= '</div>';
...
function view_i($x__type, $top_i__id = 0, $previous_i = null, $i, $control_enabled = false, $message_input = null, $focus_e = false, $completion_rate = null, $extra_class = null){
    ...
    $view_i_time = view_i_time($i_stats);
    if($view_i_time){
        $ui .= '<div class="cover-text"><a href="'.$href.'" class="doblock"><span class="light-bg coin-hover">' . $view_i_time . '</span></a></div>';
    }
