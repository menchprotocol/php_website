...
function view_i_featured($e__id_limit = 0, $i_exclude = array()){
    ...
    if($loaded_topics > $max_visible){
        ...
        //Show load button:
        $e___11035 = $CI->config->item('e___11035'); //MENCH NAVIGATION
        $ui .= '<div class="row margin-top-down all-topics center"><a  href="javascript:void(0);" onclick="$(\'.all-topics\').toggleClass(\'hidden\');" class="btn btn-large btn-default">'.$e___11035[14435]['m__icon'].' '.$e___11035[14435]['m__title'].'</a></div>';
    }
