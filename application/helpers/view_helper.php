            ...
            foreach($CI->X_model->fetch(array(
                ...
                if(strlen($reference_profile['x__message'])){
                    ...
                    if(filter_var($reference_profile['x__message'], FILTER_VALIDATE_URL)){
                        $i['i__cache'] = str_ireplace('<a href="https://'.one_two_explode('href="https://','@'.$message_references['e__handle'],$i['i__cache']).'@'.$message_references['e__handle'], ( filter_var($reference_profile['x__message'], FILTER_VALIDATE_URL) ? '' : '@'.$message_references['e__handle'].' ' ).$reference_profile['x__message'], $i['i__cache']);
                    } else {
