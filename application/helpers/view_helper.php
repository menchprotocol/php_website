    ...
    if(in_array($x__type, $CI->config->item('n___14311'))){
        ...
        foreach($CI->config->item('e___14418') as $x__type2 => $m) {
            ...
            if($x__type2==14468){
                ...
                $tab_ui .= '<div class="inline-block css__title">Editing Mode:&nbsp;</div>';
...
function view_e($x__type, $e, $extra_class = null, $source_of_e = false)
{
    ...
    if($has_any_lock && !$focus_coin) {
        ...
        $ui .= '<span title="Source Referenced in ' . $e___14690[$x__type]['m__title'] . '" data-toggle="tooltip" data-placement="top">' . $e___14690[$x__type]['m__cover'] . '</span>';
