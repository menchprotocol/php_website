    ...
    $ui  = '<div '.( isset($i['x__id']) ? ' x__id="'.$i['x__id'].'" ' : '' ).' class="i_class_'.$x__type.'_'.$i['i__id'].' no-padding big-cover '.( $show_editor ? ' home_sort ' : '' ).' '.$extra_class.'">';
        ...
        $ui .= '<div class="row">';
            $ui .= '<div class="col-9 feature-content">';
                ...
                $ui .= '<div class="space-left">'.view_i_tree_stats($i_stats, false).'</div>';
    ...
    $ui .= '<div class="row">';
        ...
        $ui .= '<div class="col-sm-6 col-md-4 col2nd">';
            ...
            $ui .= '<div class="row">';
                ...
                $ui .= '<div class="col-4">'.($is_x_progress && superpower_active(12701, true) ? '<a href="/'.$CI->uri->segment(1).'?filter__e='.$e['e__id'].'" class="inline-block" title="'.$e___11035[13670]['m_title'].'">'.$e___11035[13670]['m_icon'].'</a>' : '').view_coins_e(6255, $e['e__id']).'</div>';
            $ui .= '</div>';
