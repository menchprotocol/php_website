...
function view_i_select($i, $x__source, $previously_selected){
    ...
    $ui  = '<div class="i_cover col-md-4 col-sm-4 col-6 no-padding">';
...
function view_input_dropdown($cache_e__id, $selected_e__id, $btn_class, $e_of_i = true, $show_full_name = true, $i__id = 0, $x__id = 0){
    ...
    $ui .= '<span class="'.( $show_full_name ? ' icon-block-xs ' : '' ).'">' .$e___this[$selected_e__id]['m__icon'].'</span>'.( $show_full_name ?  $e___this[$selected_e__id]['m__title'] : '' );
