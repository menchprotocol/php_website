...
function view_i($i, $i_x_id = 0, $is_parent = false, $e_owns_i = false, $message_input = null, $extra_class = null, $control_enabled = true)
{
    ...
    $ui .= '</div>';
    $ui .= '<div class="col-sm-6 col-md-4">';
...
function view_i_list($i, $is_next, $recipient_e, $prefix_statement = null){
    ...
    $ui .= '<div class="pull-right inline-block" style="margin:5px 0 0 0;"><a href="javascript:void(0);" onclick="$(\'.handler_13509\').toggleClass(\'hidden\');" class="grey montserrat"><u>'.$e___11035[13509]['m_name'].'</u> '.$e___11035[13509]['m_icon'].'</a></div>';
...
<div class="card-body">';
        ...
        $default_active = !$previously_activated && ($counter>0 || $x__type==6225) && in_array($x__type, $CI->config->item('n___12571'));
