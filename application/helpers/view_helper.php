...
function view_i($x__type, $top_i__id = 0, $previous_i = null, $i, $message_input = null, $focus_e = false, $completion_rate = null, $extra_class = null, $is_first_incomplete = false){
    ...
    //ICON?
    $ui .= '<div class="cover-btn" title="'.( 1 ? $completion_rate['completion_percentage'].'% Completed: '.$completion_rate['steps_completed'].'/'.$completion_rate['steps_total'].' Steps & '.$completion_rate['seconds_completed'].'/'.$completion_rate['seconds_total'].' Seconds' : '' ).'">'.($show_custom_image ? view_cover(12273,$i['i__cover']) : '').'</div>';
