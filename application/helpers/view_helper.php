...
function view_i_note_list($x__type, $is_read_mode, $i, $i_notes, $e_of_i, $show_empty_error = false){
    ...
    if(in_array($x__type, $CI->config->item('n___14311'))){
        ...
        if(!in_array($x__type, $CI->config->item('n___12677')) && $e_of_i){
            ...
            $ui .= '<textarea onkeyup="i_note_count_new('.$x__type.')" class="form-control msg note-textarea regular_editor dotransparent algolia_search new-note '.( $supports_emoji ? 'emoji-input' : '' ).' input_note_'.$x__type.'" note_type_id="' . $x__type . '" style="margin-top: 10px;" placeholder="Write..."></textarea>';
