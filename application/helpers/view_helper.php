...
function view_i_note($x__type, $x, $note_e = false)
{
    ...
    if($note_e){
        ...
        //SAVE
        $ui .= '<td class="table-btn"><a class="btn btn-grey" href="javascript:save_13574(' . $x['x__id'] . ',' . $x['x__type'] . ');" title="'.$e___11035[14039]['m__title'].'">'.$e___11035[14039]['m__icon'].'</a></td>';
...
function view_i_note_list($x__type, $i_notes, $e_of_i, $show_empty_error = false, $show_headline = true){
    ...
    if(!in_array($x__type, $CI->config->item('n___12677')) && $e_of_i){
        ...
        //ADD
        $ui .= '<td class="table-btn"><a href="javascript:i_note_text('.$x__type.');" class="btn btn-grey save_notes_'.$x__type.'"><i class="fas fa-plus"></i></a></td>';

        //EMOJI
        $ui .= '<td class="table-btn" style="padding-top: 5px !important;"><span class="btn btn-grey" id="emoji_pick_type'.$x__type.'" title="'.$e___11035[14038]['m__title'].'"><span class="icon-block">'.$e___11035[14038]['m__icon'].'</span></span></td>';
