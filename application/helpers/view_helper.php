...
function view_i_tree_stats($i_stats, $show_min = false){
    ...
    //Variable time range:
    $ui = '<span class="montserrat doupper" '.( $is_interactive ? ' data-toggle="tooltip" data-placement="top" title="The number of ideas discovered & the time it takes to discover them depends on your choices that you\'ll make interactively along the way" ' : '' ).'>';
