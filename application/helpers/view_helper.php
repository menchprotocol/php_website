    ...
    if(in_array($x__type, $CI->config->item('n___14311'))){
        ...
        foreach($CI->config->item('e___14418') as $x__type2 => $m) {
            ...
            if($x__type2==14468){
                ...
                $tab_ui .= '<textarea class="form-control msg note-textarea algolia_search new-note power_editor doabsolute emoji-input input_note_'.$x__type.'" note_type_id="' . $x__type . '" placeholder="WRITE..." style="margin:0 82px 0 41px; width:calc(100% - 82px);" current_text="'.trim($textarea_content).'">'.$textarea_content.'</textarea>';
