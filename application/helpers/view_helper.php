...
function view_e_settings($list_id, $show_accordion){
    ...
    foreach($CI->config->item('e___'.$list_id) as $acc_e__id => $acc_detail) {
        ...
        if ($acc_e__id == 12289) {
            ...
            $tab_ui .= '<span><input type="text" id="e_name" class="form-control border dotransparent" value="' . $user_e['e__title'] . '" /></span>
