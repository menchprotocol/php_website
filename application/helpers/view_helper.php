...
function view_i_tree_stats($i_stats, $show_min = false){
    ...
    //Variable time range:
    $ui = '<span class="montserrat doupper underdot" style="padding-right:5px;" '.( $is_interactive ? ' data-toggle="tooltip" data-placement="right" title="# of ideas discovered & discovery time depends on the interactive choices made along the way" ': '' ).'>';
