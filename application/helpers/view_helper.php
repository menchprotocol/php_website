...
function view_i_x($i, $index_id, $can_click, $common_prefix = null, $show_editor = false, $completion_rate = null)
{
    ...
    $ui .= '<div class="row">';
        $ui .= '<div class="col-sm col-md">';
            ...
            $ui .= '<span class="icon-block">'.view_icon_i_x($completion_rate['completion_percentage'], $i, ( $index_id!=0 ? 13752 /* DISCOVERY LOCKED */ : 13822 /* Next Idea */ ) ).'</span>';
...
function view_i_cover($x__type, $i, $show_editor, $extra_class = null, $message_input = null, $user_e = false){
    ...
    $ui  = '<div '.( isset($i['x__id']) ? ' x__id="'.$i['x__id'].'" ' : '' ).' class="col-sm-6 i_class_'.$x__type.'_'.$i['i__id'].' no-padding big-cover '.( $show_editor ? ' home_sort ' : '' ).' '.$extra_class.'">';
