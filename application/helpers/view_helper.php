...
function view_i_tree_stats($i_stats, $hide_i = false){
    ...
    //TIME STATS
    $ui .= '<span class="icon-block">'.$e___13544[13292]['m_icon'].'</span><span class="montserrat '.extract_icon_color($e___13544[13292]['m_icon']).'">'.round_minutes($i_stats['i___6161']).'<span class="show-min">\'</span>'.( round_minutes($i_stats['i___6161']) != round_minutes($i_stats['i___6162']) ? '<span style="padding: 0 2px;">-</span>'.round_minutes($i_stats['i___6162']).'<span class="show-min">\'</span>' : '' ).'<span class="show-max">&nbsp;MIN.</span></span>';
