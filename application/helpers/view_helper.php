    ...
    if($player_e){
        ...
        if (in_array($i['i__type'], $CI->config->item('n___7712'))) {
            ...
            if (in_array($i['i__type'], $CI->config->item('n___43004'))) {
                ...
                $input_ui .= '<div style="padding:3px 5px;"><div class="btn btn-black inner_uploader_'.$i['i__id'].'"><span class="icon-block-sm">'.$e___11035[7637]['m__cover'].'</span>'.$e___11035[7637]['m__title'].'</div></div>';
    ...
    if(!$cache_app){
        ...
        foreach($CI->config->item('e___31904') as $x__type_target_bar => $m_target_bar) {
            ...
            if($x__type_target_bar==31770 && !$discovery_mode && $link_type_ui && $superpower_10939){
                ...
                $bottom_bar_ui .= '<span class="mini_button" style="max-width:40px;"><div class="main__title">';
