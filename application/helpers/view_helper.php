...
function view_e($x__type, $e, $extra_class = null)
{
    ...
    if(!$cache_app){
        ...
        //'.( in_array($e['e__type'], $CI->config->item('n___31109')) ? '' : 'show-on-hover' ).'
        $ui .= '<td width="20%"><div class="">'.($source_of_e && $superpower_13422 ? view_input_dropdown(6177, $e['e__type'], null, $source_of_e && $superpower_13422, false, $e['e__id']) : '').'</div></td>';
