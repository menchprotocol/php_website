...
function view_card_i($x__type, $top_i__hashtag = 0, $previous_i = null, $i, $focus_e = false){
    ...
    //Link Message if any:
    if($x__id){
        $ui .= '<div class="x__message_headline grey hideIfEmpty ignore-click ui_x__message_' . $x__id . '">'.htmlentities($i['x__message']).'</div>';
    }
...
function view_card_e($x__type, $e, $extra_class = null)
{
    ...
    if($is_app && isset($e['x__message']) && strlen($e['x__message'])){
        ...
        //Main description:
        $ui .= '<div class="x__message_headline grey hideIfEmpty ignore-click ui_x__message_' . $x__id . '" style="padding-left:40px;">'.htmlentities($e['x__message']).'</div>';
    }
