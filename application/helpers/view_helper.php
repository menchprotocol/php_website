    ...
    $ui .= '<div class="coin-cover coin-cover-right hideIfEmpty">';
        ...
        if($has_any_lock){
            ...
            if($control_enabled && isset($i['x__id']) && in_array($x__type, $CI->config->item('n___6155'))){
                $action_buttons .= '<div class="dropdown-item"><div class="x_remove css__title" i__id="'.$i['i__id'].'" x__id="'.$i['x__id'].'" title="'.$e___11035[6155]['m__title'].'"><span class="icon-block">'.$e___11035[6155]['m__cover'].'</span>'.$e___11035[6155]['m__title'].'</div></div>';
            }
