    ...
    if(!$cache_app ){
        ...
        foreach($CI->config->item('e___31904') as $x__type_top_bar => $m_top_bar) {
            ...
            if($x__type_top_bar==31770 && !$discovery_mode && $link_type_ui && $member_e){
                ...
                //GET STARTED
                $bottom_bar_ui .= '<span><a href="/'.$i['i__hashtag'].'/'.view_memory(6404,4235).'" class="btn btn-sm glow-red"><span class="icon-block-sm">'.$m_top_bar['m__cover'].'</span>'.$m_top_bar['m__title'].'</a></span>';
