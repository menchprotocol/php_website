...
function view_i_x($i, $index_id, $can_click, $common_prefix = null, $show_editor = false, $completion_rate = null)
{
    ...
    if($has_completion && $index_id==-1){
        $ui .= '<div class="progress-bg-list" title="Discovered '.$completion_rate['steps_completed'].' of '.$completion_rate['steps_total'].' Ideas ('.$completion_rate['completion_percentage'].'%)" data-toggle="tooltip" data-placement="bottom"><div class="progress-mini-done" style="width:'.$completion_rate['completion_percentage'].'%"></div></div>';
    }
...
function view_i_list($i_completed, $in_my_x, $i, $is_next, $user_e, $prefix_statement = null){
    ...
    foreach($is_next as $key => $next_i){
        ...
        $ui .= view_i_x($next_i, ( $in_my_x ? $index_id : 99 /* Locked */ ), $i_completed, $common_prefix, false, $completion_rate);
