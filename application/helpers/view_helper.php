...
function view_card_e($x__type, $e, $extra_class = null)
{
    ...
    if(!$cache_app && !$is_app) {
        ...
        foreach($CI->config->item('e___31963') as $x__type_top_bar => $m_top_bar) {
            ...
            if($x__type_top_bar==31770 && $x__id && superpower_unlocked(13422)){
            ...
            } elseif($x__type_top_bar==42795 && $member_e && $member_e['e__id']!=$e['e__id'] && (!$x__id || !in_array($e['x__type'], $CI->config->item('n___42795')))){
                ...
                $top_bar_ui .= '<td class="'.( count($followings) ? '' : 'show-on-hover' ).'">'.view_single_select_instant(42795, ( count($followings) ? $followings[0]['x__type'] : 0 ), $member_e, false, $e['e__id'], ( count($followings) ? $followings[0]['x__id'] : 0 )).'</td>';
