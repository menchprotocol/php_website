...
function view_i($x__type, $i, $control_enabled = false, $message_input = null, $focus_e = false, $completion_rate = null){
    ...
    if(!$is_any_lock){
        ...
        //IDEA TYPE
        $ui .= '<div class="cover-text montserrat">' . view_input_dropdown(4737, $i['i__type'], null, $e_of_i, false, $i['i__id']) . '<a href="'.$href.'" class="inline-block">'.view_i_time($i_stats).'</a></div>';
