...
function view_i($idea, $i_linked_id = 0, $is_parent = false, $is_source = false, $message_input = null, $extra_class = null, $control_enabled = true)
{
    ...
    if($show_toolbar){
        ...
        $ui .= '<span class="inline-block montserrat idea" title="'.$sources__12413[11020]['m_name'].'" style="text-align:left;">'.$next_ideas[0]['total_ideas'].( $i_stats['ideas_max']>$next_ideas[0]['total_ideas'] ? '<span style="padding: 0 2px;">-</span>'.$i_stats['ideas_max'] : '' ).'</span>';
