...
function view_single_select_instant($cache_e__id, $selected_e__id, $access_level_i = 0, $show_full_name = true, $o__id = 0, $x__id = 0){
    ...
    */
    ...
    $ui = '<div class="'.( $horizontal_menu ? 'dropup ' : 'dropdown ' ).( $show_full_name ? 'dropdown_type_'.$cache_e__id : '' ).' inline-block dropd_instant_'.$cache_e__id.'_'.$o__id.'_'.$x__id.'" selected_value="'.$selected_e__id.'">';
