...
function view_i_cover($x__type, $i, $show_editor, $extra_class = null, $message_input = null, $user_e = false){
    ...
    $ui .= '<a class="cover-photo '.( $completion_rate['completion_percentage']>=100 ? 'cover-done' : '' ).'" href="'.$href.'">'.i_fetch_cover($i['i__id'], true).'<h4 style="padding: 8px 0 8px 33px; font-size:0.8em;">'.view_i_title($i).'</h4></a>';
