...
function view_item($e__id, $i__id, $s__title, $s__cover, $link, $desc = null){
    ...
    <div class="d-flex justify-content-between">
      <h4 class="css__title"><b>'.( $s__cover ? '<span class="icon-block-lg title-left">'.view_cover(($e__id>0 ? 12274 : 12273),$s__cover).'</span>' : '' ).'<span class="title-right">'.$s__title.'</span></b></h4>
