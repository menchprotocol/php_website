...
function view_i_tree_stats($i_stats, $do_compact = false){
    ...
    if($i_stats['i___6169']!=$i_stats['i___6170'] || $i_stats['i___6161']!=$i_stats['i___6162']){
        ...
        $ui .= '<span class="icon-block">'.$e___13544[13629]['m_icon'].'</span><span class="montserrat '.extract_icon_color($e___13544[13629]['m_icon']).'"><span style="display: inline-block; min-width: 100px;">'.view_number($i_stats['i___6169']).'<span style="padding: 0 2px;">-</span>'.view_number($i_stats['i___6170']).'</span>'.($do_compact ? '' : '<span class="show-max">&nbsp;IDEAS</span>').'</span>'.( $do_compact ? '' : '&nbsp;&nbsp;' ).$e___13544[13292]['m_icon'].'&nbsp;<span class="montserrat '.extract_icon_color($e___13544[13292]['m_icon']).'">'.round_minutes($i_stats['i___6161']).'<span style="padding: 0 2px;">-</span>'.round_minutes($i_stats['i___6162']).( $do_compact ? '' : '<span class="show-max">&nbsp;MIN.</span>' ).'</span>';
