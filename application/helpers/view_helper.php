...
function view_coins(){
    ...
    $ui .= '<div class="row justify-content list-coins css__title" style="font-size: 1.8em; padding-bottom: 55px; line-height: 130%;"><div style="min-height:34px;"><b class="coin_count_x">'.number_format($query[0]['totals'], 0).'</b></div><a href="/18032">Transactions</a></div>';
