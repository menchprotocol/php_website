...
function view_list_e_items($i, $x__creator, $x, $plain_no_html = false, $append_m = array()){
    ...
    if(0 && $plain_no_html){
        ...
        return '<div class="source-info space-content"><span data-toggle="tooltip" data-placement="top" title="'.( $show_google_maps_link && count($append_m) ? $append_m['m__title'].( strlen($append_m['m__message']) ? ': '.$append_m['m__message'] : '' ) : '' ).'">'
