...
function view_coins(){
    ...
    $ui .= '<div class="row justify-content list-coins css__title" style="font-size: 1.8em; padding-bottom: 55px; line-height: 130%;"><span style="min-width:169px; min-height: 20px; text-align: right; display: inline-block;"><b class="coin_count_x">'.number_format($query[0]['totals'], 0).'</b></span>&nbsp;<a href="/18032" data-toggle="tooltip" data-placement="top" title="Learn more about the single Ledger that holds all data">Transactions</a></div>';
