...
function view_i_note_list($x__type, $i_notes, $e_of_i, $show_empty_error = false, $show_headline = true){
    ...
    if(!in_array($x__type, $CI->config->item('n___12677')) && $e_of_i){
        ...
        //EMOJI PICKER
        $ui .= '<td style="width:55px; padding:0;">';
        $ui .= '<label class="pull-right btn btn-grey btn-label emoji-picker" id="emojiPick'.$x__type.'" x__type="'.$x__type.'" data-toggle="tooltip" title="'.$e___11035[14038]['m__title'].' '.$e___11035[14038]['m__message'].'" data-placement="left"><span class="icon-block">'.$e___11035[14038]['m__icon'].'</span></label>';
        $ui .= '</td>';
