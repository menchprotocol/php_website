...
function view_icon_i_x($completion_percentage, $i, $not_started_type){
    ...
    return '<span title="'.$e___12446[$x_legend]['m__title'].' '.$completion_percentage.'% DONE">'.$e___12446[$x_legend]['m__icon'].'</span>';
...
function view_e_basic($e, $m = false)
{
    ...
    if($m){
        $ui .= '<span class="icon-block pull-right grey" style="margin-top:-21px;" title="'.$m['m__title'].(isset($e['x__message']) && strlen($e['x__message']) > 0 ? ' '.$e['x__message'] : '').'" data-toggle="tooltip" data-placement="top">' . view_e__icon($m['m__icon']) . '</span>';
    }
