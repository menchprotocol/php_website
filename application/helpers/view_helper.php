...
function view_i_tree_stats($i_stats, $noshow_idea, $hide_time, $hide_idea = true){
    ...
    if($i_stats['i___6161'] > 0){
        $ui .= '<span class="inline-block grey '.( $hide_time ? ' i_x_stats hidden ' : '' ).'" '.( !$cover_show ? 'style="min-width:120px;"' : '' ).'>';
...
function view_i_note_list($x__type, $i_notes, $e_of_i, $show_empty_error = false){
    ...
    if(!in_array($x__type, $CI->config->item('n___12677')) && $e_of_i){
        ...
        $ui .= '<table class="table table-condensed" style="margin-bottom: 16px; margin-top: 10px;"><tr>';
