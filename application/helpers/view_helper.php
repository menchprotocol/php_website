...
function view_i($x__type, $top_i__id = 0, $previous_i = null, $i, $focus_e = false, $completion_rate = null, $extra_class = null, $is_first_incomplete = false){
    ...
    if(0 && is_new()){
      ...
      <div class="card">
        ...
        $ui .= '<td width="20%" style="text-align: left;"><div>'.(!$discovery_mode && $editing_enabled ? view_input_dropdown(4737, $i['i__type'], null, $editing_enabled, false, $i['i__id']) : '').'</div></td>';
        ...
        $ui .= '<td width="20%" style="text-align: right;"><div class="show-on-hover">'.$o_menu.'</div></td>';
        $ui .= '</tr></table>';
