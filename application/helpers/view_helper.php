...
function view_body_e($x__type, $counter, $e__id){
    ...
    if($x__type==12273){
        ...
        if($superpower_10939){
            $ui .= '<div class="col-md-6 col-12 container-center"><div class="new-list-'.$x__type.' list-group"><div class="list-group-item dropdown_12273 list-adder">
        ...
        $add_button = '<div class="col-md-6 col-12 container-center"><div class="new-list-'.$x__type.' dropdown_'.$x__type.' list-adder">
                    <div class="input-group border">
                        <input type="text"
                               class="form-control form-control-thick algolia_search dotransparent add-input"
...
function view_body_i($x__type, $counter, $i__id){
    ...
    if($x__type==11019){
        ...
        if($e_of_i){
            $ui .= '<div class="col-md-6 col-12 container-center"><div class="new-list-11019 dropdown_11019 list-adder '.superpower_active(10939).'">
                    <div class="input-group border">
                        <input type="text"
        ...
        if($e_of_i){
            $ui .= '<div class="col-md-6 col-12 container-center"><div class="new-list-12273 dropdown_12273 list-adder '.superpower_active(10939).'">
                <div class="input-group border">
                    <input type="text"
                           class="form-control form-control-thick add-input algolia_search dotransparent"
                           maxlength="' . view_memory(6404,4736) . '"
        ...
        $ui .= '<div class="col-md-6 col-12 container-center"><div class="new-list-'.$x__type.' dropdown_12274 list-adder '.superpower_active(10939).'">
                    <div class="input-group border">
                        <input type="text"
                               class="form-control form-control-thick algolia_search dotransparent add-input"
                               maxlength="' . view_memory(6404,6197) . '"
...
function view_i_card($x__type, $top_i__id = 0, $previous_i = null, $i, $focus_e = false, $tree_progress = null, $extra_class = null){
    ...
    //Top action menu:
    $ui = '<div i__id="'.$i['i__id'].'" '.( $x__id ? ' x__id="'.$x__id.'" ' : '' ).' class="coin_cover '.( $focus_coin ? ' focus-coin slim_flat col-md-6 col-12
...
function view_e_card($x__type, $e, $extra_class = null)
{
    ...
    //Source UI
    $ui  = '<div e__id="' . $e['e__id'] . '" '.( isset($e['x__id']) ? ' x__id="'.$e['x__id'].'" ' : '' ).' class="coin_cover no-padding coin___12274_'.$e['e__id'].' '.$extra_class.( $is_app ? ' coin-6287 ' : '' ).( $has_sortable ? ' sort_draggable ' : '' ).( $discovery_mode ? ' coinface-6255 coin-6255 coinface-12274 coin-12274 ' : ' coinface-12274 coin-12274  ' ).( $focus_coin ? ' focus-coin slim_flat col-md-6 col-12 ' : ' edge-coin coin_e_click col-md-4 col-6 ' ).( $show_text_editor ? ' doedit ' : '' ).( isset($e['x__id']) ? ' cover_x_'.$e['x__id'].' ' : '' ).( $has_soft_lock ? ' not-allowed ' : '' ).'">';
