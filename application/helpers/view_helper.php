    ...
    foreach($CI->config->item('e___'.$e__id) as $m) {
        $ui .= '<div class="col-12 col-sm-4">';
            $ui .= '<div class="info_box">';
                ...
                $ui .= '<div class="info_box_title montserrat">'.$m['m__title'].'</div>';
...
function view_i($x__type, $i, $message_input = null, $focus_e = false, $completion_rate = null){
    ...
    $is_soft_lock = ($locking_enabled || !$focus_e) && ($is_hard_lock || (in_array($x__type, $CI->config->item('n___14377')) && !$completion_rate['completion_percentage']));
