...
function view_card_i($x__type, $top_i__hashtag = 0, $previous_i = null, $i, $focus_e = false){
    ...
    if($x__id){
        $ui .= '<span class="icon-block-xx '.( !strlen($i['x__message']) ? ' hidden ' : '' ).' ui_x__message_' . $x__id . '" title="'.htmlentities($i['x__message']).'" data-toggle="tooltip" data-placement="top" data-html="true">'.$e___11035[4372]['m__cover'].'</span>';
    }
...
function view_card_e($x__type, $e, $extra_class = null)
{
    ...
    if ($grant_privacy && $x__id && !$is_app) {
        $ui .= '<span class="icon-block-xx '.( !strlen($e['x__message']) ? ' hidden ' : '' ).' ui_x__message_' . $x__id . '" title="'.htmlentities($e['x__message']).'" data-toggle="tooltip" data-placement="top" data-html="true">'.$e___11035[4372]['m__cover'].'</span>';
