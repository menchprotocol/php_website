...
function view_i_tree_stats($i_stats, $hide_idea){
    ...
    //TIME STATS
    $ui .= '<span class="i_x_stats hidden inline-block">';
...
function view_i_list($in_my_x, $i, $is_next, $user_e, $prefix_statement = null, $can_click = false, $index_id = 99 /* Locked */){
    ...
    if($index_id >= 0){
        ...
        $ui .= '<div class="pull-right grey right-adj"><a href="javascript:void(0);" onclick="$(\'.i_x_stats\').toggleClass(\'hidden\')">'.$e___11035[13689]['m_title'].' '.$e___11035[13689]['m_icon'].'</a></div>';
