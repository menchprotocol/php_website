        ...
        if(count($query)){
            ...
            if(!$e__id_limit){
                ...
                if($count_query[0]['totals'] > $limit){
                    ...
                    $see_all_link = '<a href="/browse/'.$e__id.'" title="'.number_format($count_query[0]['totals'], 0).' Ideas"><span class="icon-block">'.$m['m__icon'].'</span><u>'.$m['m__title'].'</u>&nbsp;<i class="fas fa-chevron-right" style="font-size: 0.9em !important; margin-left:3px;"></i></a>';
                }
            }
