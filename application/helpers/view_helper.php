...
function view_i($x__type, $top_i__id = 0, $previous_i = null, $i, $control_enabled = false, $message_input = null, $focus_e = false, $completion_rate = null, $extra_class = null, $is_first_incomplete = false){
    ...
    if($focus_coin){
        ...
        $ui .= '<td width="33%" class="push_down '.superpower_active(10939).'" style="text-align: right;"><div>'.( $discovery_mode ? '' : ( i_is_startable($i) ? '<span data-toggle="tooltip" data-placement="top" title="Startable Idea"><i class="fad fa-play zq12273"></i></span>' : '<span data-toggle="tooltip" data-placement="top" title="Continuing Idea (Not Startable)"><i class="fad fa-step-forward zq12273"></i></span>' ) ).'</div></td>';
