        ...
        if (in_array($i['i__type'], $CI->config->item('n___7712'))) {
            ...
            if (in_array($i['i__type'], $CI->config->item('n___43004'))) {
                $input_ui .= '<div class="media_outer_frame hideIfEmpty">
                        <div id="media_frame_'.$i['i__id'].'" class="media_frame media_frame_'.$i['i__id'].' hideIfEmpty">'.view_i_media($i).'</div>
                ...
                $input_ui .= '<script> $(document).ready(function () { load_cloudinary(43004, '.$i['i__id'].', [\'#'.$i['i__id'].'\'], \'.inner_uploader_'.$i['i__id'].'\'); setTimeout(function () { display_media(\'media_frame_'.$i['i__id'].'\', 43004, '.$i['i__id'].'); }, 144); }); </script>';
            }
