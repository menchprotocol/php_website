...
class Read extends CI_Controller
{
    ...
    function load_oii(){
        ...
        if(count($lns)>0){
            ...
            if($has_more_links){
                $message .= '<div id="link_page_'.$next_page.'"><a href="javascript:void(0);" style="margin:10px 0 72px 0;" class="btn btn-read" onclick="load_oii(link_filters, link_join_by, '.$next_page.');"><span class="icon-block"><i class="far fa-plus-circle"></i></span>Page '.$next_page.'</a></div>';
                $message .= '';
            } else {
