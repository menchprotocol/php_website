...
class Cron extends CI_Controller
{
    ...
    function report(){
        ...
        //Email Body
        $html_message = '<br />';
        $html_message .= '<div>Here is what happened from '.date("l M jS G:i:s", $last_week_start_timestamp).' to '.date("l M jS G:i:s", $last_week_end_timestamp).' '.config_var(11079).' Time:</div>';
        $html_message .= '<br />';
