...
class Ledger extends CI_Controller
{
    ...
    function ledger_load(){
        ...
        if(count($lns)>0){
            ...
            $message .= '<div class="alert alert-warning" role="alert" style="margin-top:20px;"><span class="icon-block"><i class="fas fa-exclamation-circle"></i></span>No Links found with the selected filters. Modify filters and try again.</div>';
