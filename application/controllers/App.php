...
class App extends CI_Controller
{
    ...
    function i_copy()
    {
        ...
        return view_json($this->Cacheideas->recursive_clone(intval($_POST['ideaid']), intval($_POST['do_recursive']), $player_e['playerid']));
    ...
    function new_idea()
    {
        ...
        return view_json($this->Cacheideas->create_or_link($_POST['focus_card'], $_POST['linktype'], trim($_POST['new_ideatext']), $member_e['playerid'], $_POST['focus_id'], $_POST['link_ideaid']));
    ...
    function x_update_instant_select()
    {
        ...
        if (is_array($_POST['o__id'])) {
            ...
            return view_json($this->Menchledger->x_update_instant_select($_POST['focus__id'], $_POST['o__id'], $_POST['element_id'], $_POST['new_playerid'], $_POST['migrate_s__handle'], $_POST['linkid']));
        }
    ...
    function x_4341()
    {
        ...
        $x = $this->Menchledger->fetch($query_filters, $joined_by, view_memory(6404, 11064), $query_offset);
