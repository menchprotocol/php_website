...
class View extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        if(
            ...
            && !array_key_exists($first_segment, $this->config->item('handle___14582'))
            ...
            if($is_login_verified){
                foreach($this->E_model->fetch(array(
                    ...
                    //Login:
                    $this->E_model->activate_session($e_user, true);
    ...
    function app_load($app_e__id = 14563 /* Error if none provided */){
        ...
        if(!$ui){
            ...
            //Prep view:
            $raw_app = $this->load->view('view/'.$app_e__id, array(
                'app_e__id' => $app_e__id,
