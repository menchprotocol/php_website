    ...
    function editor_load_e()
    {
        ...
        foreach($this->X_model->fetch(array(
            ...
            foreach($this->X_model->fetch(array(
                ...
                $profile_header = '<div class="profile_header grey main__title"><span class="icon-block-xs icon-block-img">'.view_cover($e_group['e__cover']).'</span>'.$e_group['e__title'].'<span class="icon-block-xs icon-block-img">'.view_cover($e_template['e__cover']).'</span>'.$e_template['e__title'].'</div>';
