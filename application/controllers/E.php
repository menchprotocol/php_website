    ...
    function editor_load_e()
    {
        ...
        foreach($this->X_model->fetch(array(
            ...
            foreach($this->X_model->fetch(array(
                ...
                $profile_header = '<div class="profile_header main__title"><span class="icon-block">'.view_cover($e_template['e__cover']).'</span>'.$e_template['e__title'].'<span class="icon-block" title="For following '.stripslashes($e_group['e__title']).' @'.$e_group['e__handle'].'" data-toggle="tooltip" data-placement="top">'.$e___11035[42178]['m__cover'].'</span></div>';
