                ...
                foreach($this->config->item('e___'.$e_template['e__id']) as $dynamic_e__id => $m) {
                    ...
                    if(in_array($data_type, $this->config->item('n___42188'))){
                        ...
                        array_push($return_inputs, array(
                            ...
                            'd__is_radio' => 1,
                            'd_x__id' => 0,
                            'd__html' => view_select($dynamic_e__id, $es[0]['e__id'], 0),
                            'd__value' => '',
                            'd__type_name' => '',
                            'd__placeholder' => '',
                        ...
                        foreach($this->X_model->fetch(array(
                            ...
                            if(strlen($curr_val['x__message']) && !in_array($curr_val['x__message'], $unique_values)){
                                ...
                                array_push($return_inputs, array(
                                    ...
                                    'd__html' => '<span class="icon-block-xs">'.$m['m__cover'].'</span>'.$m['m__title'].': '.( !in_array($curr_val['e__privacy'], $this->config->item('n___33240')) ? '<span title="'.$e___6177[$curr_val['e__privacy']]['m__title'].'" data-toggle="tooltip" data-placement="top">'.$e___6177[$curr_val['e__privacy']]['m__cover'].'</span>' : '' ).( strlen($e___42179[$dynamic_e__id]['m__message']) ? '<span class="icon-block-xs" title="'.$e___42179[$dynamic_e__id]['m__message'].'" data-toggle="tooltip" data-placement="top">'.$e___11035[42179]['m__cover'].'</span>' : '' ).( $is_required ? ' <b title="Required Field" style="color:#FF0000;">*</b>' : '' ),
