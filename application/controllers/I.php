    ...
    function i_load_coin(){
        ...
        if (!isset($_POST['i__id']) || !isset($_POST['x__type']) || !isset($_POST['first_segment']) || !isset($_POST['counter'])) {
            ...
            if($_POST['x__type']==12274 || $_POST['x__type']==6255){
                ...
                foreach(view_coins_i($_POST['x__type'], $_POST['i__id'], 1, false, view_memory(6404,11064)) as $source_e) {
                ...
                foreach(view_coins_i($_POST['x__type'], $_POST['i__id'], 1, false, view_memory(6404,11064)) as $next_i) {
