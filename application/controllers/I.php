...
class I extends CI_Controller {
    ...
    function editor_load_i()
    {
        ...
        $profile_header = '<div class="profile_header main__title"><span class="icon-block-sm icon-block-img">'.$e___4737[$is[0]['i__type']]['m__cover'].'</span>'.$e___4737[$is[0]['i__type']]['m__title'].'</div>';
