...
class Entities extends CI_Controller
{
    ...
    function add_company(){
        ...
        $company_en = $this->Entities_model->en_verify_create(trim($_POST['company_name']), $user_en['en']['en_id'], false, 6181);
        if(!$company_en['status']){
            //We had an error, return it:
            return echo_json($company_en);
        }


        //Create default company intent:
        $company_intent = $this->Intents_model->in_link_or_create(11902 /* Get hired at a Mench partner company */, 0, 'Get hired at '.$company_en['en']['en_name'], $user_en['en']['en_id'], 6184 /* Intent Published */, 6684 /* OR Intent Single Answer */);
        ...
        $company_learn_intent = $this->Intents_model->in_link_or_create(11907 /* Learn more about a Mench partner company */, 0, 'Learn more about '.$company_en['en']['en_name'], $user_en['en']['en_id'], 6184 /* Intent Published */, 6677 /* AND Intent Got It */);
        ...
        $this->Links_model->ln_create(array(
            'ln_parent_entity_id' => 3504, //English Language
            'ln_type_entity_id' => 4230, //Raw link
            'ln_miner_entity_id' => $user_en['en']['en_id'],
            'ln_child_entity_id' => $user_en['en']['en_id'],
        ));
        ...
        //Link this user to the company
        $this->Links_model->ln_create(array(
            'ln_type_entity_id' => 4255, //Text link
            'ln_miner_entity_id' => $user_en['en']['en_id'],
            'ln_parent_entity_id' => $user_en['en']['en_id'],
        ...
        //new company joined:
        $this->Links_model->ln_create(array(
            'ln_type_entity_id' => 7505, //Company Joined Mench
            'ln_miner_entity_id' => $user_en['en']['en_id'],
            'ln_parent_entity_id' => $company_en['en']['en_id'],
        ));
