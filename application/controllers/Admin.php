...
class Admin extends CI_Controller
{
    ...
    function extra_stats_intents(){
        ...
        foreach ($fixed_fields['in_status'] as $status_num => $status) {
            ...
            $this_ui .= '<td style="text-align: right;">' . ($objects_count[0]['totals'] > 0 ? '<a href="/links?in_status=' . $status_num . '&ln_type_entity_id=' . $created_en_type_id . '"  data-toggle="tooltip" title="View Links" data-placement="top">' . number_format($objects_count[0]['totals'], 0) . '</a>' : $objects_count[0]['totals']) . ' ' . $en_all_4534[$obj_en_id]['m_icon'] . '</td>';
            $this_ui .= '</tr>';
    ...
    function extra_stats_entities(){
        ...
        foreach ($fixed_fields['en_status'] as $status_num => $status) {
            ...
            $this_ui .= '<tr class="'.( $status_num < 0 ? 'is-removed' : '' ).'">';
            $this_ui .= '<td style="text-align: left;"><span style="width:29px; display: inline-block; text-align: center;">' . $status['s_icon'] . '</span><span class="underdot" data-toggle="tooltip" title="' . $status['s_desc'] . '" data-placement="top">' . $status['s_name'] . '</span></td>';
            $this_ui .= '<td style="text-align: right;">' . ($objects_count[0]['totals'] > 0 ? '<a href="/links?en_status=' . $status_num . '&ln_type_entity_id=' . $created_en_type_id . '"  data-toggle="tooltip" title="View Links" data-placement="top">' . number_format($objects_count[0]['totals'], 0) . '</a>' : $objects_count[0]['totals']) . ' ' . $en_all_4534[$obj_en_id]['m_icon'] . '</td>';
            $this_ui .= '</tr>';
    ...
    function extra_stats_links(){
        ...
        foreach ($fixed_fields['ln_status'] as $status_num => $status) {
            ...
            $this_ui .= '<tr class="'.( $status_num < 0 ? 'is-removed' : '' ).'">';
            $this_ui .= '<td style="text-align: left;"><span style="width:29px; display: inline-block; text-align: center;">' . $status['s_icon'] . '</span><span class="underdot" data-toggle="tooltip" title="' . $status['s_desc'] . '" data-placement="top">' . $status['s_name'] . '</span></td>';
            $this_ui .= '<td style="text-align: right;">' . ($objects_count[0]['totals'] > 0 ? '<a href="/links?ln_status=' . $status_num . '&ln_type_entity_id=' . $created_en_type_id . '"  data-toggle="tooltip" title="View Links" data-placement="top">' . number_format($objects_count[0]['totals'], 0) . '</a>' : $objects_count[0]['totals']) . ' ' . $en_all_4534[$obj_en_id]['m_icon'] . '</td>';
            $this_ui .= '</tr>';
