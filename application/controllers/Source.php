...
class Source extends CI_Controller
{
    ...
    function load_leaderboard(){
        ...
        */
        ...
        echo '<td class="blog fixedColumns MENCHcolumn2 montserrat" title="TOTAL '.$en_all_2738[4535]['m_name'].'S: '.number_format($this->config->item('cache_count_idea'), 0).'"><span class="icon-block">'.$en_all_2738[4535]['m_icon'].'</span>'.echo_number($this->config->item('cache_count_idea')).'</td>';
        echo '<td class="idea fixedColumns MENCHcolumn3 montserrat" title="TOTAL '.$en_all_2738[6205]['m_name'].'S: '.number_format($this->config->item('cache_count_read'), 0).'"><span class="icon-block">'.$en_all_2738[6205]['m_icon'].'</span>'.echo_number($this->config->item('cache_count_read')).'</td>';
        echo '</tr>';
