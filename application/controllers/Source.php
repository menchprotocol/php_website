...
class Source extends CI_Controller
{
    ...
    function en_ln_type_preview()
    {
        ...
        return echo_json(array(
            ...
            'en_link_preview' => ( in_array($detected_ln_type['ln_type_source_id'], $this->config->item('en_ids_12524')) || $_POST['ln_id'] ? echo_url_types($_POST['ln_content'], $detected_ln_type['ln_type_source_id']) : ''),
        ));
