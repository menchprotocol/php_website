...
class X extends CI_Controller
{
    ...
    function x_upload()
    {
        ...
        return view_json(array(
            'status' => 1,
            'message' => '<div class="headline"><span class="icon-block">'.$e___11035[13980]['m__icon'].'</span>'.$e___11035[13980]['m__title'].'</div><div class="previous_answer">'.$this->X_model->message_send($new_message, true).'</div>',
        ));
