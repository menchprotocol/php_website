    ...
    function x_load(){
        ...
        if($total_items_loaded > 0){
            ...
            if($page_num==1){
                ...
                $message .= '<div class="montserrat x-info">'.$e___11035[4341]['m_icon'].' '.$e___11035[4341]['m_name'].' has '.number_format($x_count[0]['total_count'] , 0).' TRANSACTIONS indexing <span class="source inline-block">'.$e___12467[12274]['m_icon'].' '.number_format($this->config->item('s___12274'), 0).' '.$e___12467[12274]['m_name'].'</span> & <span class="idea inline-block">'.$e___12467[12273]['m_icon'].' '.number_format($this->config->item('s___12273'), 0).' '.$e___12467[12273]['m_name'].'</span> with <span class="discover inline-block">'.$e___12467[6255]['m_icon'].' '.number_format($this->config->item('s___6255'), 0).' '.$e___12467[6255]['m_name'].'</span>. Here\'s the last '.$total_items_loaded.' TRANSACTIONS:</div>';
            } else {
                //Subsequent messages:
