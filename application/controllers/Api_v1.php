...
class Api_v1 extends CI_Controller {
    ...
    function load_inbound_c(){
        ...
        if(count($parent_cs)>1 || (count($parent_cs)>0 && intval($_POST['cr_id'])==0)){
            $parent_ui = '';
            $parent_ui .= '<div class="title" style="margin-top:10px;"><h4><b><i class="fas fa-sitemap rotate180"></i> Other Parent Inetents</b></a></h4></div>';
    ...
    function c_import_process(){
        ...
        if(isset($_POST['b_outbound_c_ids']) && count($_POST['b_outbound_c_ids'])>0){
            foreach($_POST['b_outbound_c_ids'] as $c_id){
                ...
                //Fetch all Tree for this Intent:
