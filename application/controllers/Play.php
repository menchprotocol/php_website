            ...
            <div class="row">
                <table class="mench-navigation" style="border-bottom:0;">
                    <tr>
                        ...
                        <td style="text-align:right; width:160px; padding-right: 7px;"><a href="https://docs.google.com/forms/d/e/1FAIpQLSca_W0_pP1anDmJ9_iJx82icCXTjKMjblXCx9hIHrlScwUoGg/viewform" class="btn btn-play montserrat">START PLAY <i class="fas fa-arrow-right"></i></a></td>
                    </tr>
                </table>
            </div>
        </div>';
        ...
        */
        ...
        if(count($blog_coins) > 0){
            foreach ($blog_coins as $count=>$ln) {
                ...
                if($count==$show_max){
                    echo '<tr class="see_more_who"><td colspan="3"><span class="parent-icon icon-block-sm"><i class="fas fa-search-plus"></i></span><a href="javascript:void(0);" onclick="$(\'.see_more_who\').toggleClass(\'hidden\')">TOP '.$load_max.'</a></td></tr>';
                ...
                //PLAY
                echo '<td style="width: 33%"><span class="parent-icon icon-block-sm">'.echo_en_icon($ln).'</span>'.( $session_en ? '<a href="/play/'.$ln['en_id'].'">'.$first_name.'</a>' : $first_name ).' '.echo_rank($count+1).'</td>';
