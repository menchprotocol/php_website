        ...
        if (data.status) {
            ...
            if(data.remove_from_ui){
                ...
                if (modify_data['tr_id'] > 0) {
                    ...
                    //Update 2x icons:
                    $('.tr_type_' + modify_data['tr_id']).html('<span class="tr_type_val" data-toggle="tooltip" data-placement="right" title="' + en_all_4592[data.js_tr_type_en_id]["m_name"] + ': ' + en_all_4592[data.js_tr_type_en_id]["m_desc"] + '">' + en_all_4592[data.js_tr_type_en_id]["m_icon"] + '</span>');
