        ...
        $.post("/entities/fn___add_source_paste_url", { input_url:input_url }, function (data) {
            ...
            if (!data.status) {
                ...
                if(data.js_digested_url.cleaned_url != input_url){
                    ...
                    $('#cleaned_url').html('Canonical URL: <a href=' + data.js_digested_url.cleaned_url + '" target="_blank" class="url_truncate" style="max-width:450px; text-decoration:underline;">' + data.js_digested_url.cleaned_url + '</a>');
                }
