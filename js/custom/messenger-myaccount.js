...
function radio_update(parent_en_id, selected_en_id, enable_mulitiselect){
    ...
    $.post("/players/myaccount_radio_update", {
...
function save_full_name(){
    ...
    //Save the rest of the content:
    $.post("/players/myaccount_save_full_name", {
        en_id: en_creator_id,
        en_name: $('#en_name').val(),
    }, function (data) {
...
function save_phone(){
    ...
    //Save the rest of the content:
    $.post("/players/myaccount_save_phone", {
        en_id: en_creator_id,
...
function save_email(){
    ...
    //Save the rest of the content:
    $.post("/players/myaccount_save_email", {
        en_id: en_creator_id,
...
function myaccount_update_password(){
    ...
    //Save the rest of the content:
    $.post("/players/myaccount_update_password", {
        en_id: en_creator_id,
...
function save_social_profiles(){
    ...
    //Show spinner:
    $('.save_social_profiles').html('<span><i class="far fa-yin-yang fa-spin"></i> ' + echo_saving_notify() +  '</span>').hide().fadeIn();
    ...
    //Save the rest of the content:
    $.post("/players/myaccount_save_social_profiles", {
        en_id: en_creator_id,
